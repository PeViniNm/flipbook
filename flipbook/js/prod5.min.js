!(function () {
  ...
  window.Hash =
    ((e = {
      ...
      fragment: function () {
        var e = r();
        return n
          ? window.location.pathname + (e[1] ? "#" + e[1] : "")
          : e[1] || "";
      },
      get: function (e, t) {
        var i,
        ...
        for (i in t)
          Object.prototype.hasOwnProperty(i) &&
            a.push(encodeURIComponent(i) + "=" + encodeURIComponent(t[i]));
        return (
          a.length > 0 && (a = "?" + a.join("&")),
          n ? e + a : r()[0] + "#" + e + a
        );
          ...
          a ||
            (a = setInterval(function () {
              i > 0 &&
                ...
                ((s = window.location.href), window.Hash.check());
            }, 100)),
          this
        );
      },
      check: function () {
        ...
        for (i in t)
          if (Object.prototype.hasOwnProperty.call(t, i))
            if (
              ((t[i].regexp = t[i].regexp || new RegExp(i)),
              (n = t[i].regexp.exec(a)))
            )
              for (
                t[i].title && (document.title = t[i].title), e = 0;
                e < t[i].listeners.length;
                e++
              )
  ...
  (function (e) {
    ...
    var t,
      ...
      n = {
        init: function (a) {
          ...
          c.when))
            Object.prototype.hasOwnProperty.call(c.when, u) &&
              this.bind("zoom." + u, c.when[u]);
          for (u in o.zoom.flipbookEvents)
            Object.prototype.hasOwnProperty.call(o.zoom.flipbookEvents, u) &&
              c.flipbook.bind(u, o.zoom.flipbookEvents[u]);
          this.css({ position: "relative", overflow: "hidden" }),
            e.isTouch
              ? (c.flipbook
                  .bind("touchstart", o.zoom.eventTouchStart)
                  .bind("touchmove", o.zoom.eventTouchMove)
                  .bind("touchend", o.zoom.eventTouchEnd),
                this.bind("touchstart", n._tap))
            ...
            ? u[0]
              ? u[1]
                ...
                : ((p.width = s.width() / 2),
                  (i = "ltr" == r ? 0 : p.width),
                  (t = l(
                    "ltr" == r ? d.left - c.left : d.left - c.left + p.width,
                    d.top - c.top
                  )))
              : ((p.width = s.width() / 2),
                (i = "ltr" == r ? p.width : 0),
                (t = l(
                  "ltr" == r ? d.left - c.left + p.width : d.left - c.left,
                  d.top - c.top
                )))
        ...
        zoomIn: function (t) {
            ...
            ((i =
              void 0 !== t
                ? "x" in t && "y" in t
                  ...
                  : e.isTouch
                  ? l(
                      t.originalEvent.touches[0].pageX - f.x - p.left,
                      t.originalEvent.touches[0].pageY - f.y - p.top
                    )
          ...
          var y = l((i.x - m.x) * c + m.x, (i.y - m.y) * c + m.y),
            b = l(
              h.size.width * c > this.width() ? i.x - y.x : 0,
              h.size.height * c > this.height() ? i.y - y.y : 0
            ),
            _ = l(
              Math.abs(h.size.width * c - this.width()),
              Math.abs(h.size.height * c - this.height())
            ),
            x = l(
              Math.min(0, h.size.width * c - this.width()),
              Math.min(0, h.size.height * c - this.height())
            ),
            T = l(m.x * c - m.x - f.x - b.x, m.y * c - m.y - f.y - b.y);
          T.y > _.y
            ? (b.y = T.y - _.y + b.y)
            : T.y < x.y && (b.y = T.y - x.y + b.y),
            T.x > _.x
              ? (b.x = T.x - _.x + b.x)
              : T.x < x.x && (b.x = T.x - x.x + b.x),
            (T = l(m.x * c - m.x - f.x - b.x, m.y * c - m.y - f.y - b.y));
          var E = {};
          E[g + "transition"] =
            g +
          ...
          var S = function () {
            a.trigger("zoom.zoomIn"),
              ...
              d
                .turn("zoom", c)
                .css({ position: "absolute", margin: "", top: 0, left: 0 });
            var t = d.offset();
            (s.axis = l(t.left - p.left, t.top - p.top)),
              w &&
                "double" == d.turn("display") &&
                (("ltr" == d.turn("direction") && !d.turn("view")[0]) ||
                  ("rtl" == d.turn("direction") && !d.turn("view")[1])) &&
                (s.axis.x = s.axis.x + d.width() / 2),
              a.zoom("scroll", T),
        ...
        zoomOut: function (t) {
          ...
          if (((t = void 0 !== t ? t : s.opts.duration), s.zoomIn)) {
            ...
            var m = {};
            (m[p + "transition"] =
              p + "transform " + s.opts.easeFunction + " " + t + "ms"),
              d.css(m);
            var g,
              v = e("<div />", {
                css: {
            ...
            var y = e.findPos(d[0]);
            i = l(
              -d.width() / 2 - y.left + v.width() / 2 + g.x + h.left,
              -d.height() / 2 - y.top + v.height() / 2 + g.y + h.top
            );
            var b = function () {
              d[0].style.removeProperty
                ? (d[0].style.removeProperty(p + "transition"),
                  d
                    .transform(
                      d.turn("options").acceleration ? r(0, 0, !0) : ""
                    )
                    .turn("zoom", 1),
        ...
        flipbookWidth: function () {
          var e = this.data().zoom.opts.flipbook,
            t = e.turn("view");
          return "double" != e.turn("display") || (t[0] && t[1])
            ? e.width()
            : e.width() / 2;
        },
        ...
        resize: function () {
          ...
          if (this.zoom("value") > 1) {
            var i = t.offset(),
              n = this.offset();
            (e.axis = l(
              i.left - n.left + (e.axis.x + e.scrollPos.x),
              i.top - n.top + (e.axis.y + e.scrollPos.y)
            )),
              "double" != t.turn("display") ||
                "ltr" != t.turn("direction") ||
                t.turn("view")[0] ||
                (e.axis.x = e.axis.x + t.width() / 2),
        ...
        _eTurning: function (e, t, i) {
          ...
          if (((s.page = r.turn("page")), 1 != a)) {
            for (var o = 0; o < i.length; o++)
              i[o] &&
                this.trigger("zoom.resize", [a, i[o], r.data().pageObjs[i[o]]]);
            setTimeout(function () {
              n.zoom("resize");
            }, 0);
          }
        ...
        _eTurned: function (e, t) {
          if (1 != this.zoom("value")) {
            var i = this.data().zoom,
              n = i.opts.flipbook;
            t > i.page
              ? this.zoom("scroll", l(0, i.scrollPos.y), !1, !0)
              : t < i.page &&
                this.zoom("scroll", l(n.width(), i.scrollPos.y), !1, !0);
          }
        },
        _ePressed: function () {
        ...
        _eMouseDown: function (t) {
          return (
            (e(this).data().zoom.draggingCur = e.isTouch
              ? l(
        ...
        _eMouseMove: function (t) {
          ...
          if (i.draggingCur) {
            ...
            return (
              e(this).zoom(
                "scroll",
                l(i.scrollPos.x - a.x, i.scrollPos.y - a.y),
                !0
              ),
              (i.draggingCur = n),
              !1
        ...
        _eTouchMove: function (t) {
          ...
          i.touch &&
            ...
            (i.touch.speed.x =
              0 === i.touch.speed.x
                ? i.touch.motion.x / (s - i.touch.timestamp)
                : (i.touch.speed.x +
                    i.touch.motion.x / (s - i.touch.timestamp)) /
                  2),
            (i.touch.last = r),
        ...
        _eTouchEnd: function (t) {
          ...
          if (i.touch && 1 == e(this).zoom("value")) {
            ...
            n < 50 &&
            (i.touch.speed.x < -1 || i.touch.last.x - i.touch.initial.x < -100)
              ? this.trigger("zoom.swipeLeft")
              : n < 50 &&
                (i.touch.speed.x > 1 ||
                  i.touch.last.x - i.touch.initial.x > 100) &&
        ...
        _eDestroying: function () {
          ...
          i.flipbookEvents))
            Object.prototype.hasOwnProperty.call(i.flipbookEvents, s) &&
              a.unbind(s, i.flipbookEvents[s]);
          a
            .unbind("touchstart", i.eventTouchStart)
            .unbind("touchmove", i.eventTouchMove)
            .unbind("touchend", i.eventTouchEnd),
    ...
    function a(e, t) {
      return (
        e[0] != t[0] &&
        (!!e.attr("page") || (!!e.parent()[0] && a(e.parent(), t)))
      );
    }
    function s(e) {
      function t(e) {
      ...
      return (
        (t.prototype = new Error()), (t.prototype.constructor = t), new t(e)
      );
    }
    function r(e, i, n) {
      return t && n
  ...
  (function (e) {
    ...
    var t,
      ...
      h = {
        init: function (a) {
          ...
          (t =
            ...
            "MozPerspective" in document.body.style),
            (i =
              !(s = /AppleWebkit\/([0-9\.]+)/i.exec(navigator.userAgent)) ||
              parseFloat(s[1]) > 534.3),
            (n = x());
          var l,
            d = 0,
            c = this.data(),
          ...
          return (
            e(this)
              .bind(o.down, c.eventHandlers.touchStart)
              .bind("end", h._eventEnd)
              .bind("pressed", h._eventPressed)
              .bind("released", h._eventReleased)
              .bind("flip", h._flip),
            e(this).parent().bind("start", c.eventHandlers.start),
            e(document)
              .bind(o.move, c.eventHandlers.touchMove)
              .bind(o.up, c.eventHandlers.touchEnd),
        ...
        addPage: function (t, i) {
          ...
          if (
            ((n = /\bp([0-9]+)\b/.exec(e(t).attr("class"))) &&
              (i = parseInt(n[1], 10)),
            i)
          ) {
            if (i == o) s = !0;
          ...
          return (
            i >= 1 &&
              ...
              -1 != navigator.userAgent.indexOf("MSIE 9.0") &&
                r.pageObjs[i].hasClass("hard") &&
                r.pageObjs[i].removeClass("hard"),
        ...
        _addPage: function (t) {
          ...
          if (n)
            if (h._necessPage.call(this, t)) {
              ...
              (i.pagePlace[t] = 0), i.pageObjs[t] && i.pageObjs[t].remove();
        },
        hasPage: function (e) {
          ...
          if ("prevented" != E("destroying", this)) {
            for (
              i.destroying = !0,
                ...
                e(document)
                  .unbind(o.move, i.eventHandlers.touchMove)
                  .unbind(o.up, i.eventHandlers.touchEnd);
              0 !== i.totalPages;

            )
              this.turn("removePage", i.totalPages);
            return (
              i.fparent && i.fparent.remove(),
          ...
          if ("number" == typeof t) {
            ...
            for (var l = 0; l < a.length; l++)
              a[l] &&
                ...
                (this.trigger("zoomed", [a[l], a, i.pageZoom[a[l]], i.zoom]),
                (i.pageZoom[a[l]] = i.zoom));
            return this;
          }
          return i.zoom;
        ...
        _pageSize: function (e, t) {
          ...
          if ("single" == i.display)
            (n.width = this.width()),
              ...
              t && ((n.top = 0), (n.left = 0), (n.right = "auto"));
          else {
            var a = this.width() / 2,
              s = this.height();
            if (
              (i.pageObjs[e].hasClass("own-size")
                ? ((n.width = i.pageObjs[e].width()),
                  (n.height = i.pageObjs[e].height()))
              ...
              (n.top = (s - n.height) / 2),
                "ltr" == i.direction
                  ? ((n[r ? "right" : "left"] = a - n.width),
                    (n[r ? "left" : "right"] = "auto"))
                  : ((n[r ? "left" : "right"] = a - n.width),
                    (n[r ? "right" : "left"] = "auto"));
            }
          }
          return n;
        ...
        range: function (e) {
          ...
          return (
            (a[1] = a[1] || a[0]),
            a[0] >= 1 && a[1] <= s.totalPages
              ? ((t = Math.floor(2)),
                s.totalPages - a[1] > a[0]
                  ? (n = 2 * t - (i = Math.min(a[0] - 1, t)))
                  : (i = 2 * t - (n = Math.min(s.totalPages - a[1], t))))
              : ((i = 5), (n = 5)),
        ...
        _necessPage: function (e) {
          ...
          return (
            this.data().pageObjs[e].hasClass("fixed") ||
            (e >= t[0] && e <= t[1])
          );
        },
        ...
        _removePageFromDOM: function (e) {
          ...
          t.pageObjs[e] && t.pageObjs[e].remove(),
            t.pageWrap[e] && (t.pageWrap[e].remove(), delete t.pageWrap[e]),
        ...
        removePage: function (e) {
          ...
          if ("*" == e)
            ...
            t.pageObjs[e] &&
              ...
              t.page > t.totalPages
                ? ((t.page = null), h._fitPage.call(this, t.totalPages))
                : (h._makeRange.call(this), this.turn("update"));
          }
          return this;
        },
          ...
          var i,
            ...
            r = function (e) {
              var i = e + t,
                ...
                o = r ? " odd " : " even ";
              a.pageObjs[e] &&
                (a.pageObjs[i] = a.pageObjs[e]
                  .removeClass("p" + e + " odd even")
                  .addClass("p" + i + o)),
                a.pagePlace[e] &&
                  a.pageWrap[e] &&
                  ((a.pagePlace[i] = i),
                  a.pageObjs[i].hasClass("fixed")
                    ? (a.pageWrap[i] = a.pageWrap[e].attr("page", i))
                    : (a.pageWrap[i] = a.pageWrap[e]
                        .css(h._pageSize.call(n, i, !0))
                        .attr("page", i)),
                  a.pages[e] &&
                    (a.pages[i] = a.pages[e].flip("options", {
                      page: i,
                      next: s || r ? i + 1 : i - 1,
                    })),
                  t &&
          ...
          switch (t) {
            case "single":
              i.pageObjs[0] ||
                ...
                (i.pageObjs[0] = e("<div />", { class: "page p-temporal" })
        ...
        direction: function (t) {
          ...
          if (((t = t.toLowerCase()), -1 == e.inArray(t, c)))
            throw S('"' + t + '" is not a value for direction');
          return (
            "rtl" == t && e(this).attr("dir", "ltr").css({ direction: "ltr" }),
            (i.direction = t),
        ...
        corner: function () {
          var e,
            ...
            i = this.data();
          for (t in i.pages)
            if (_(t, i.pages) && (e = i.pages[t].flip("corner"))) return e;
          return !1;
        },
        data: function () {
          return this.data();
        ...
        disable: function (t) {
          var i,
            n = this.data(),
            a = this.turn("view");
          for (i in ((n.disabled = void 0 === t || !0 === t), n.pages))
            _(i, n.pages) &&
              n.pages[i].flip(
                "disable",
                !!n.disabled || -1 == e.inArray(parseInt(i, 10), a)
              );
          return this;
        },
        disabled: function (e) {
        ...
        size: function (e, t) {
          ...
          for (i in (this.css({ width: e, height: t }),
          a.pageObjs[0] && a.pageObjs[0].css({ width: s, height: t }),
          a.pageWrap))
            _(i, a.pageWrap) &&
              ((n = h._pageSize.call(this, i, !0)),
              a.pageObjs[i].css({ width: n.width, height: n.height }),
              a.pageWrap[i].css(n),
              a.pages[i] &&
                a.pages[i].css({ width: n.width, height: n.height }));
        ...
        resize: function () {
          ...
          for (
            t.pages[0] &&
              (t.pageWrap[0].css({ left: -this.width() }),
        ...
        _removeMv: function (e) {
          ...
          for (t = 0; t < i.pageMv.length; t++)
            if (i.pageMv[t] == e) return i.pageMv.splice(t, 1), !0;
          return !1;
        },
        _addMv: function (e) {
          var t = this.data();
        ...
        view: function (e) {
          ...
          return "double" == t.display
            ? [i[0] > 0 ? i[0] : 0, i[1] <= t.totalPages ? i[1] : 0]
            : [i[0] > 0 && i[0] <= t.totalPages ? i[0] : 0];
        },
        stop: function (e, t) {
          if (this.turn("animating")) {
            var i,
              ...
              s = this.data();
            for (
              s.tpage && ((s.page = s.tpage), delete s.tpage), i = 0;
              i < s.pageMv.length;
              i++
            )
              s.pageMv[i] &&
                s.pageMv[i] !== e &&
                ((n = (a = s.pages[s.pageMv[i]]).data().f.opts),
                a.flip("hideFoldedPage", t),
                t || f._moveFoldingPage.call(a, !1),
                n.force &&
                  ((n.next = n.page % 2 == 0 ? n.page - 1 : n.page + 1),
                  delete n.force));
          }
        ...
        pages: function (e) {
          ...
          if (e) {
            if (e < t.totalPages)
              for (var i = t.totalPages; i > e; i--) this.turn("removePage", i);
          ...
          if ((h._missing.call(this, e), t.pageObjs[e])) {
            ...
            for (var n = 0; n < i.length; n++)
              i[n] &&
                ...
                (this.trigger("zoomed", [i[n], i, t.pageZoom[i[n]], t.zoom]),
                (t.pageZoom[i[n]] = t.zoom));
            h._removeFromDOM.call(this),
        ...
        _turnPage: function (t) {
          ...
          if (a.page != t) {
            ...
            if ("prevented" == E("turning", this, [t, o]))
              return void (
                l == a.page &&
                -1 != e.inArray(s, a.pageMv) &&
                a.pages[s].flip("hideFoldedPage", !0)
              );
        ...
        page: function (t) {
          ...
          if (!i.disabled && !i.destroying) {
            if ((t = parseInt(t, 10)) > 0 && t <= i.totalPages)
              return (
                t != i.page &&
                  (i.done && -1 == e.inArray(t, this.turn("view"))
                    ? h._turnPage.call(this, t)
                    : h._fitPage.call(this, t)),
                this
              );
        ...
        previous: function () {
          return this.turn(
            "page",
            Math.max(1, h._view.call(this, this.data().page).shift() - 1)
          );
        },
        peel: function (e, t) {
          var i,
        ...
        _eventStart: function (e, t, i) {
          null != t &&
            null != t.turn &&
            null != t.turn.trigger &&
            t.turn.trigger("peelStart", [t]);
          var n = t.turn.data(),
            a = n.pageZoom[t.page];
          e.isDefaultPrevented() ||
            (a &&
              a != n.zoom &&
              (t.turn.trigger("zoomed", [
                t.page,
                t.turn.turn("view", t.page),
                a,
                n.zoom,
              ]),
            ...
            "single" == n.display &&
              i &&
              ((("l" == i.charAt(1) || "l" == i.charAt(0)) &&
                "ltr" == n.direction) ||
              (("r" == i.charAt(1) || "r" == i.charAt(0)) &&
                "rtl" == n.direction)
        ...
        _eventEnd: function (t, i, n) {
          ...
          if (
            (null != i &&
              null != i.turn &&
              null != i.turn.trigger &&
              i.turn.trigger("peelEnd", [i, n]),
            n)
          ) {
            var r = s.tpage || s.page;
            (r != i.next && r != i.page) ||
              (delete s.tpage, h._fitPage.call(a, r || i.next, !0));
          } else
        ...
        _eventReleased: function (t, i) {
          ...
          (n =
            "single" == o.display
              ? "br" == i.corner || "tr" == i.corner || "r" == i.corner
                ? i.x < a.width() / 2
                : i.x > a.width() / 2
              : i.x < 0 || i.x > a.width()),
            (new Date().getTime() - s.time < 200 || n) &&
              (t.preventDefault(),
              i && !0 === i.fit
                ? h._fitPage.call(r, s.opts.next)
                : h._turnPage.call(r, s.opts.next)),
            (o.mouseAction = !1);
        },
        _flip: function (t) {
          t.stopPropagation();
        ...
        _touchStart: function (t) {
          if (
            ...
            if (
              null == window.disableTurnEvents ||
              1 != window.disableTurnEvents
            ) {
              var i = this.data();
              for (var n in i.pages)
                if (
                  _(n, i.pages) &&
                  !1 === f._eventStart.apply(i.pages[n], arguments)
                )
                  return !1;
                ...
                (n = i.pages[t]) &&
                  ...
                  i.tpage
                    ? n
                        ...
                        .flip(
                          "disable",
                          -1 == e.inArray(parseInt(t, 10), i.pageMv) &&
                            t != l[0] &&
                            t != l[1]
                        )
                    : n
                        .flip("hover", !1 === r)
                        .flip("disable", t != o[0] && t != o[1])));
          } else
            for (t in i.pageWrap)
              if (_(t, i.pageWrap)) {
        ...
        _updateShadow: function () {
          ...
          switch (
            ...
            case 1:
              a.shadow
                .css({ width: o, height: r, top: 0, left: o })
                .addClass("shadow-half-left");
              break;
            case 2:
              a.shadow
                .css({ width: o, height: r, top: 0, left: 0 })
        ...
        _setPageLoc: function (e) {
          ...
          if (
            (e == i[0] || e == i[1]
              ? (n = 1)
              : (("single" == t.display && e == i[0] + 1) ||
                  ("double" == t.display && e == i[0] - 2) ||
                  e == i[1] + 2) &&
                (n = 2),
            !this.turn("animating"))
          )
      ...
      f = {
        ...
        options: function (t) {
          var i = this.data().f;
          return t
            ? (f.setData.call(this, { opts: e.extend({}, i.opts || u, t) }),
              this)
            : i.opts;
        },
        z: function (e) {
        ...
        _cornerActivated: function (t) {
          ...
          switch (i.effect) {
            ...
            case "sheet":
              let e = a / 2,
                i = a / 2;
              if ((t.isHovering && ((e = a / 6), (i = a - a / 6)), s.y < e))
                s.corner += "t";
              else {
                if (!(s.y >= i)) return !1;
                s.corner += "b";
        ...
        _isIArea: function (e) {
          ...
          return (
            (e = r && e.originalEvent ? e.originalEvent.touches[0] : e),
        ...
        _backGradient: function () {
          var t = this.data().f,
            ...
            n =
              i.opts.gradients &&
              ("single" == i.display ||
                (2 != t.opts.page && t.opts.page != i.totalPages - 1));
          return (
            n &&
              !t.bshadow &&
              (t.bshadow = e("<div/>", g(0, 0, 1))
                .css({
                  position: "",
                  width: this.width(),
                  height: this.height(),
        ...
        resize: function (e) {
          ...
          switch (t.effect) {
            case "hard":
              e &&
                (t.wrapper.css({ width: n, height: a }),
                t.fpage.css({ width: n, height: a }),
                i.opts.gradients &&
                  (t.ashadow.css({ width: n, height: a }),
                  t.bshadow.css({ width: n, height: a })));
              break;
            case "sheet":
              if (e) {
                ...
                t.wrapper.css({ width: s, height: s }),
                  t.fwrapper
                    ...
                    .css({ width: n, height: a }),
                  t.fpage.css({ width: n, height: a }),
                  i.opts.gradients && t.ashadow.css({ width: n, height: a }),
                  f._backGradient.call(this) &&
                    t.bshadow.css({ width: n, height: a });
              }
              if (t.parent.is(":visible")) {
                var r = M(t.parent[0]);
                t.fwrapper.css({ top: r.top, left: r.left }),
                  (r = M(t.opts.turn[0])),
                  t.fparent.css({ top: -r.top, left: -r.left });
              }
            ...
            switch (t.effect) {
              case "hard":
                ...
                (s[n + "transform-style"] = "preserve-3d"),
                  ...
                  (t.wrapper = e("<div/>", g(0, 0, 2))
                    .css(s)
                    .appendTo(a)
                    .prepend(this)),
                  (t.fpage = e("<div/>", g(0, 0, 1))
                    .css(s)
                    .appendTo(a)
                    .addClass("fold-page")),
                  i.opts.gradients &&
                    ((t.ashadow = e("<div/>", g(0, 0, 0)).hide().appendTo(a)),
              ...
              case "sheet":
                ...
                this.css({
                  ...
                  (t.wrapper = e("<div/>", g(0, 0, this.css("z-index")))
                    .appendTo(a)
                    .prepend(this)),
                  (t.fwrapper = e("<div/>", g(a.offset().top, a.offset().left))
                    .hide()
                    .appendTo(t.fparent)
                    .addClass("fold-wrapper")),
                  (t.fpage = e("<div/>", g(0, 0, 0, "visible"))
                    .css({ cursor: "default" })
                    .appendTo(t.fwrapper)
                    .addClass("fold-page")),
                  i.opts.gradients &&
                    (t.ashadow = e("<div/>", g(0, 0, 1)).appendTo(t.fpage)),
        ...
        _fold: function (e) {
          ...
          switch (t.effect) {
            case "hard":
              "l" == e.corner
                ? (e.x = Math.min(Math.max(e.x, 0), 2 * l))
                : (e.x = Math.max(Math.min(e.x, l), -l));
              var c,
                p,
                u,
                h,
              ...
              switch (e.corner) {
                case "l":
                  (h = "0% 50%"),
                    (m = "100% 50%"),
                    S
                      ? ((c = 0), (p = t.opts.next - 1 > 0), (u = 1))
                      : ((c = "100%"), (p = t.opts.page + 1 < g), (u = 0));
                  break;
                case "r":
                  (h = "100% 50%"),
                    (m = "0% 50%"),
                    ...
                    (l = -l),
                    S
                      ? ((c = 0), (p = t.opts.next + 1 < g), (u = 0))
                      : ((c = "-100%"), (p = 1 != t.opts.page), (u = 1));
              }
              (_[n + "perspective-origin"] = m),
                ...
                t.fpage.transform(
                  "translateX(" + l + "px) rotateY(" + (180 + E) + "deg)",
                  h
                ),
                t.parent.css(_),
                S
                  ? ((x = 1 - x),
                    t.wrapper.css({ zIndex: v + 1 }),
                    t.fpage.css({ zIndex: v }))
                  : ((x -= 1),
                    t.wrapper.css({ zIndex: v }),
                    t.fpage.css({ zIndex: v + 1 })),
                r.opts.gradients &&
                  (p
                    ? t.ashadow
                        .css({
                          display: "",
                          left: c,
                          backgroundColor: "rgba(0,0,0," + 0.5 * x + ")",
                        })
                        .transform("rotateY(0deg)")
                    : t.ashadow.hide(),
                  t.bshadow.css({ opacity: 1 - x }),
                  S
                    ? t.bshadow.parent()[0] != t.wrapper[0] &&
                      t.bshadow.appendTo(t.wrapper)
                    : t.bshadow.parent()[0] != t.fpage[0] &&
              ...
              var M,
                ...
                X = function () {
                  ...
                  if (
                    ...
                    c > s &&
                      ((F.x = F.x + Math.abs((F.y * t.y) / t.x)),
                      (F.y = 0),
                      Math.round(F.x * Math.tan(a - c)) < d))
                  )
                    return (
                      (e.y = Math.sqrt(Math.pow(d, 2) + 2 * n.x * t.x)),
                      W && (e.y = d - e.y),
                      X()
                    );
                  if (c > s) {
                    var h = a - c,
                      m = G - d / Math.sin(h);
                    (D = w(
                      Math.round(m * Math.cos(h)),
                      Math.round(m * Math.sin(h))
                    )),
                      N && (D.x = -D.x),
                      W && (D.y = -D.y);
                  }
                  ...
                  if (
                    ...
                    (k = Math.sin(s * (_ > 1 ? 2 - _ : _))),
                      ...
                      f._backGradient.call(O) &&
                        ((P = w(
                          ((1.2 * $ * Math.sin(c)) / l) * 100,
                          ((1.2 * $ * Math.cos(c)) / d) * 100
                        )),
                        N || (P.x = 100 - P.x),
                        W || (P.y = 100 - P.y));
                  }
                  ...
                  O.css(p).transform(b(a) + y(e.x + h, e.y, R), m),
                    t.fpage
                      ...
                      .transform(
                        b(a) +
                          y(
                            e.x + L.x - D.x - (l * n[0]) / 100,
                            e.y + L.y - D.y - (d * n[1]) / 100,
                            R
                          ) +
                          b((180 / a - 2) * a),
                        m
                    ...
                    t.wrapper.transform(
                      y(-e.x + o - h, -e.y + c, R) + b(-a),
                      m
                    ),
                    t.fwrapper.transform(
                      y(-e.x + D.x + o, -e.y + D.y + c, R) + b(-a),
                      m
                    ),
                    r.opts.gradients &&
                      (n[0] && (C.x = 100 - C.x),
          ...
          if (t) {
            ...
            if (e) {
              ...
              if (n.pages[t.folding]) {
                ...
                n.pageWrap[t.folding] &&
                  n.pageObjs[t.folding].appendTo(n.pageWrap[t.folding]);
          ...
          if (i) {
            if (!s || !a.point || a.point.corner != e.corner) {
              var r =
                "hover" == a.status ||
                "peel" == a.status ||
                a.opts.turn.data().mouseAction
                  ? e.corner
                  : null;
              if (((s = !1), "prevented" == E("start", this, [a.opts, r])))
                return !1;
            }
            if (t) {
              var o = this,
                l =
                  a.point && a.point.corner == e.corner
                    ? a.point
                    : f._c.call(this, e.corner, 1);
              this.animatef({
                from: [l.x, l.y],
                to: [e.x, e.y],
                duration: 500,
        ...
        hide: function () {
          ...
          switch (e.effect) {
            case "hard":
              t.opts.gradients &&
                ((e.bshadowLoc = 0), e.bshadow.remove(), e.ashadow.hide()),
                e.wrapper.transform(""),
                e.fpage.hide();
              break;
            case "sheet":
              ...
              var s = f._c.call(this, n.corner),
                r =
                  "t" == n.corner.substr(0, 1)
                    ? Math.min(0, n.y - s.y) / 2
                    : Math.max(0, n.y - s.y) / 2,
                o = w(n.x, n.y + r),
                l = w(s.x, s.y - r);
              this.animatef({
                from: 0,
        ...
        turnPage: function (e) {
          ...
          var a =
              i.point ||
              f._c.call(this, e.corner, i.opts.turn ? n.opts.elevation : 0),
          ...
          if ("single" == i.data().display) {
            if (!t.corner && !t.disabled) {
              if (this.flip("isTurning") && t.point)
                return (
                  (t.point.fit = !0),
                  "prevented" != E("released", this, [t.point]) &&
                    f.hideFoldedPage.call(this, !1),
                  void f._eventStart.call(this, e)
                );
              if (
                ((t.corner = f._isIArea.call(this, e)),
                t.corner && f._foldingPage.call(this))
              )
                return (
                  this.trigger("pressed", [t.point]),
            ...
            !t.disabled &&
            !this.flip("isTurning") &&
            t.opts.page == i.data().pagePlace[t.opts.page]
          ) {
            if (
              ((t.corner = f._isIArea.call(this, e)),
              t.corner && f._foldingPage.call(this))
        ...
        _eventMove: function (e) {
          ...
          if (!t.disabled)
            if (((e = r ? e.originalEvent.touches : [e]), t.corner)) {
              ...
              if (n) {
                if (
                  ("sheet" == t.effect && 2 == n.corner.length) ||
                  "hard" == t.effect
                ) {
                  t.status = "hover";
                ...
                "hover" == t.status &&
                  ((t.status = ""), f.hideFoldedPage.call(this, !0));
            }
        },
        _eventEnd: function () {
          var e = this.data().f,
          ...
          !e.disabled &&
            t &&
            "prevented" != E("released", this, [e.point || t]) &&
        ...
        peel: function (t, i) {
          ...
          if (t) {
            ...
            if (-1 != e.inArray(t, f._cAllowed.call(this))) {
              ...
              (n.status = "peel"),
                f._showFoldedPage.call(this, { corner: t, x: a.x, y: a.y }, i);
            }
    ...
    function v(e, t, i, n, a) {
      ...
      return w(
        Math.round(
          r * e.x + 3 * a * s * s * t.x + 3 * a * a * s * i.x + o * n.x
        ),
        Math.round(
          r * e.y + 3 * a * s * s * t.y + 3 * a * a * s * i.y + o * n.y
        )
      );
    }
    function w(e, t) {
    ...
    function x() {
      for (
        var e = ["Moz", "Webkit", "Khtml", "O", "ms"], t = e.length, i = "";
        t--;

      )
        e[t] + "Transform" in document.body.style &&
          (i = "-" + e[t].toLowerCase() + "-");
      return i;
    }
    function T(e, t, i, a, s) {
      ...
      if ("-webkit-" == n) {
        ...
        var l =
            (i = { x: (i.x / 100) * e.width(), y: (i.y / 100) * e.height() })
              .x - t.x,
          d = i.y - t.y,
          c = Math.atan2(d, l),
          p = c - Math.PI / 2,
          u =
            Math.abs(e.width() * Math.sin(p)) +
            Math.abs(e.height() * Math.cos(p)),
          h = Math.sqrt(d * d + l * l),
        ...
        e.css({
          "background-image":
            n + "linear-gradient(" + -c + "rad," + o.join(",") + ")",
        });
      }
    }
    function E(t, i, n) {
              ...
              var n = [],
                ...
                l = function () {
                  if (i.effect && s) {
                    for (
                      var e = [],
                        d = Math.min(t.duration, new Date().getTime() - o),
                        c = 0;
                      c < a;
                      c++
                    )
                      e.push(
                        i.effect.easing(1, d, t.from[c], n[c], t.duration)
                      );
                    t.frame(1 == a ? e[0] : e),
                      d == t.duration
                        ? (delete i.effect,
  ...
  (function (e) {
    ...
    function c(e, t) {
      return (
        o.settings.adjustOldDeltas && "mousewheel" === e.type && t % 120 == 0
      );
    }
    e.fn.extend({
      ...
      i.find("*").each(function () {
        ...
        (t = this),
          e.each(t.attributes, function () {
            var i = this.name,
              n = this.value;
            (0 != i.indexOf("on") && 0 != n.indexOf("javascript:")) ||
              e(t).removeAttr(i);
          });
      }),
      i.html()
...
var scaler = {
  getObjectFitSize: function (e, t, i, n, a) {
    var s = n / a,
      ...
      l = 0;
    return (
      (e ? s > r : s < r) ? (l = (o = t) / s) : (o = (l = i) * s),
      { width: o, height: l, x: (t - o) / 2, y: (i - l) / 2 }
    );
  },
  isInIframe: function () {
    try {
  ...
  isParentDifferentDomain: function () {
    try {
...
!(function (e) {
    ...
    return (function (e) {
      if (e) {
        var t = function (e) {
          ...
          y = function (e) {
            e.observeMutations &&
              ((e.observer = new MutationObserver(m(e, 1))),
      ...
      function S(e) {
        ...
        return "string" == typeof e
          ? E(t(document.querySelectorAll(e)), i)
          : E([e], i)[0];
      }
    ...
    if (
      (null == e &&
        $("[data-fit-text]").each(function () {
          let e = {};
          "" != $.trim($(this).attr("data-fit-min"))
            ? (e.minFontSize = $(this).attr("data-fit-min"))
            : (e.minFontSize = "8"),
            "" != $.trim($(this).attr("data-fit-max"))
  ...
  ($.cssToObject = function (e) {
    let t = {};
    return (
      e.replace(/(?:^|;)\s*([^:]+)\s*:\s*([^;]+)\s*/g, (e, i, n) => (t[i] = n)),
      t
    );
  }),
  (function (e, t) {
    ...
    const c = {
      ...
      on: function () {
        ...
        "function" == typeof t[1] && (([n, s, r] = t), (a = void 0)),
          r || (r = !1);
        const c = n.split(" ");
        let p;
        ...
        for (let e = 0; e < o.length; e += 1) {
          ...
          for (let e = 0; e < this.length; e += 1) {
            ...
            if (
              (!a && i.dom7Listeners
                ? (n = i.dom7Listeners[t])
                : a && i.dom7LiveListeners && (n = i.dom7LiveListeners[t]),
              n && n.length)
            )
              for (let e = n.length - 1; e >= 0; e -= 1) {
                ...
                (s &&
                  ...
                  ? (i.removeEventListener(t, a.proxyListener, r),
                    n.splice(e, 1))
                  : s ||
                    (i.removeEventListener(t, a.proxyListener, r),
                    n.splice(e, 1));
            ...
            void 0 !== s &&
              ...
              (f(e[a]) && f(n[a])
                ? n[a].__swiper__
                  ...
                  : g(e[a], n[a])
                : !f(e[a]) && f(n[a])
                ? ((e[a] = {}), n[a].__swiper__ ? (e[a] = n[a]) : g(e[a], n[a]))
                : (e[a] = n[a]));
          }
        }
      }
    ...
    var M = {
      ...
      updateSlides: function () {
        ...
        for (let a = 0; a < p; a += 1) {
          ...
          const r = c.eq(a);
          if (
            (E && e.grid.updateSlide(a, r, p, t), "none" !== r.css("display"))
          ) {
        ...
        if (
          ...
          if (0 === t) o[e ? "scrollLeft" : "scrollTop"] = -c;
            ...
            if (!s.support.smoothScroll)
              return (
                w({ swiper: s, targetPosition: -c, side: e ? "left" : "top" }),
                !0
              );
      ...
      slideTo: function (e, t, i, n, a) {
        ...
        if (o.cssMode) {
          ...
          if (0 === t) {
            ...
            if (!s.support.smoothScroll)
              return (
                w({ swiper: s, targetPosition: i, side: e ? "left" : "top" }),
                !0
              );
    ...
    function k(e) {
      ...
      if (!i.allowTouchMove)
        return (
          d(c.target).is(a.focusableElements) || (i.allowClick = !1),
          void (
            a.isTouched &&
            (Object.assign(r, {
              startX: h,
      ...
      if (
        (a.allowTouchCallbacks && i.emit("touchMove", c),
      ...
      if (
        (a.isScrolling && i.emit("touchMoveOpposite", c),
          ...
          ? ((w = !1),
            s.resistance &&
              (a.currentTranslate =
                i.minTranslate() -
                1 +
                (-i.minTranslate() + a.startTranslate + v) ** y))
          : v < 0 &&
            ...
            s.resistance &&
              (a.currentTranslate =
                i.maxTranslate() +
                1 -
                (i.maxTranslate() - a.startTranslate - v) ** y)),
    ...
    function O(e) {
      ...
      if (c > n.longSwipesMs) {
        ...
        "next" === t.swipeDirection &&
          (w >= n.longSwipesRatio
            ? t.slideTo(n.rewind && t.isEnd ? g : f + y)
            : t.slideTo(f)),
        ...
        breakpoints: {
          ...
          getBreakpoint: function (e, t, i) {
            ...
            for (let e = 0; e < o.length; e += 1) {
              ...
              "window" === t
                ? a.matchMedia(`(min-width: ${r}px)`).matches && (n = s)
                : r <= i.clientWidth && (n = s);
            }
            return n || "max";
          },
    ...
    const se = [
      function (e) {
        ...
        function o(e) {
          ...
          (m = i.rtlTranslate ? "right" : i.isHorizontal() ? "left" : "top"),
            a
              ? ((g = Math.floor(t / 2) + n + l),
                (v = Math.floor(t / 2) + n + o))
              : ((g = t + (n - 1) + l), (v = n + o));
          ...
          if (
            ...
            return (
              i.slidesGrid !== u && b !== h && i.slides.css(m, `${b}px`),
              i.updateProgress(),
      ...
      function (e) {
        ...
        function w(e) {
          let i = t.$el;
          "container" !== t.params.mousewheel.eventsTarget &&
            (i = d(t.params.mousewheel.eventsTarget)),
            i[e]("mouseenter", f),
            i[e]("mouseleave", m),
            i[e]("wheel", v);
        }
      ...
      function (e) {
        ...
        function p() {
          ...
          if (
            ("fraction" === i.type &&
              (s.find(U(i.currentClass)).text(i.formatFractionCurrent(p + 1)),
          ...
          "custom" === i.type && i.renderCustom
            ? (s.html(i.renderCustom(t, p + 1, u)), a("paginationRender", s[0]))
            : a("paginationUpdate", s[0]),
            t.params.watchOverflow &&
              t.enabled &&
      ...
      function (e) {
        ...
        function T(e) {
          ...
          o.touch
            ? (d[u](n.start, b, c), d[u](n.move, _, c), d[u](n.end, x, p))
            : (d[u](a.start, b, c), r[u](a.move, _, c), r[u](a.end, x, p));
        }
        function E() {
          ...
          0 === s.length &&
            ((s = d(`<div class="${t.params.scrollbar.dragClass}"></div>`)),
            a.append(s)),
      ...
      function (e) {
        ...
        function b(e) {
          ...
          f.$imageEl && 0 !== f.$imageEl.length
            ? (i.gestures
                ? (a.scale = e.scale * p)
                : (a.scale = (f.scaleMove / f.scaleStart) * p),
              a.scale > f.maxRatio &&
                (a.scale = f.maxRatio - 1 + (a.scale - f.maxRatio + 1) ** 0.5),
              a.scale < n.minRatio &&
                (a.scale = n.minRatio + 1 - (n.minRatio - a.scale + 1) ** 0.5),
        ...
        function k() {
          ...
          i.gestures
            ...
            : "touchstart" === t.touchEvents.start &&
              (t.$wrapperEl.on(t.touchEvents.start, s, y, n),
              t.$wrapperEl.on(t.touchEvents.move, s, b, a),
              t.$wrapperEl.on(t.touchEvents.end, s, _, n),
              t.touchEvents.cancel &&
                t.$wrapperEl.on(t.touchEvents.cancel, s, _, n)),
            t.$wrapperEl.on(
              t.touchEvents.move,
        ...
        function O() {
          ...
          i.gestures
            ...
            : "touchstart" === t.touchEvents.start &&
              ...
              t.touchEvents.cancel &&
                t.$wrapperEl.off(t.touchEvents.cancel, s, _, n)),
            t.$wrapperEl.off(
              t.touchEvents.move,
              `.${t.params.zoom.containerClass}`,
              x,
      ...
      function (e) {
        ...
        function f(e) {
          ...
          t.navigation &&
            ...
            t.pagination &&
              n.is(U(t.params.pagination.bulletClass)) &&
              n[0].click();
        }
        function m() {
          return (
          ...
          n("fromEdge toEdge afterInit lock unlock", () => {
            t.params.a11y.enabled &&
              (function () {
                ...
                i &&
                  i.length > 0 &&
                  (t.isBeginning ? (u(i), o(i)) : (h(i), r(i))),
                  e && e.length > 0 && (t.isEnd ? (u(e), o(e)) : (h(e), r(e)));
              })();
          }),
          n("paginationUpdate", () => {
            t.params.a11y.enabled &&
      ...
      function (e) {
        ...
        (i.autoplay = { running: !1, paused: !1 }),
          ...
          s("sliderFirstMove", () => {
            i.autoplay.running &&
              (i.params.autoplay.disableOnInteraction ? d() : c());
          }),
          s("touchEnd", () => {
            i.params.cssMode &&
              i.autoplay.paused &&
          ...
          (a.grid = {
            ...
            updateWrapperSize: (e, i, n) => {
              ...
              if (
                ...
                a.$wrapperEl.css({ [n("width")]: `${a.virtualSize + s}px` }),
                r)
              ) {
                i.splice(0, i.length);
                const e = [];
          ...
          te({
            ...
            setTransition: (e) => {
              ...
              (i ? t.slides.find(i) : t.slides).transition(e),
                ne({ swiper: t, duration: e, transformEl: i, allSlides: !0 });
            },
            overwriteParams: () => ({
              slidesPerView: 1,
              slidesPerGroup: 1,
            ...
            if (
              ...
              if (u)
                ...
                const e = Math.abs(m) - 90 * Math.floor(Math.abs(m) / 90),
                  ...
                  a = p.shadowOffset;
                f.transform(
                  `scale3d(${i}, 1, ${n}) translate3d(0px, ${r / 2 + a}px, ${
                    -r / 2 / n
                  }px) rotateX(-90deg)`
                );
              }
      ...
      function (e) {
        ...
        const a = (e, i, n) => {
          ...
          0 === a.length && (a = ae(n, e, t.isHorizontal() ? "left" : "top")),
            0 === s.length &&
              (s = ae(n, e, t.isHorizontal() ? "right" : "bottom")),
        ...
        te({
          ...
          recreateShadows: () => {
            ...
            t.slides.each((i) => {
              ...
              let s = n[0].progress;
              t.params.flipEffect.limitRotation &&
                (s = Math.max(Math.min(i.progress, 1), -1)),
                a(n, s, e);
            });
          },
  ...
  (function (e, t, i, n) {
    ...
    function b(e, t) {
      for (
        var i, a, s = t[0].toUpperCase() + t.slice(1), r = 0;
        r < ae.length;
          ...
          (t.timeStamp = de()),
            ...
            (function (e, t) {
              var i = t.center,
                ...
                a = e.prevDelta || {},
                s = e.prevInput || {};
              (t.eventType !== ye && s.eventType !== _e) ||
                ((a = e.prevDelta = { x: s.deltaX || 0, y: s.deltaY || 0 }),
    ...
    function J(e, t) {
      return (
        ((t = t || {}).recognizers = p(t.recognizers, J.defaults.preset)),
        new ee(e, t)
      );
    }
    function ee(e, t) {
    ...
    function te(e, t) {
      ...
      n.style &&
        (r(e.options.cssProps, function (a, s) {
          (i = b(n.style, s)),
            t
              ? ((e.oldCssProps[i] = n.style[i]), (n.style[i] = a))
    ...
    (N.prototype = {
      ...
      recognizeWith: function (e) {
        ...
        return (
          t[(e = B(e, this)).id] || ((t[e.id] = e), e.recognizeWith(this)), this
        );
      },
      dropRecognizeWith: function (e) {
        return (
          s(e, "dropRecognizeWith", this) ||
            ((e = B(e, this)), delete this.simultaneous[e.id]),
          this
        );
      },
      requireFailure: function (e) {
        ...
        return (
          -1 === v(t, (e = B(e, this))) && (t.push(e), e.requireFailure(this)),
          this
        );
      },
      ...
      recognize: function (e) {
        ...
        return c(this.options.enable, [this, t])
          ? (this.state & (rt | ot | lt) && (this.state = it),
            (this.state = this.process(t)),
            void (this.state & (nt | at | st | ot) && this.tryEmit(t)))
      ...
      l(q, Y, {
        ...
        attrTest: function (e) {
          return (
            ...
            (this.state & nt || (!(this.state & nt) && this.directionTest(e)))
          );
        },
        emit: function (e) {
      ...
      l(V, Y, {
        ...
        attrTest: function (e) {
          return (
            ...
            (Math.abs(e.scale - 1) > this.options.threshold || this.state & nt)
          );
        },
        emit: function (e) {
          if (1 !== e.scale) {
      ...
      l(U, N, {
        ...
        process: function (e) {
          ...
          if (((this._input = e), !n || !i || (e.eventType & (_e | xe) && !s)))
            this.reset();
      ...
      l(Z, Y, {
        ...
        attrTest: function (e) {
          return (
            this._super.attrTest.call(this, e) &&
            (Math.abs(e.rotation) > this.options.threshold || this.state & nt)
          );
        },
      }),
      l(Q, Y, {
      ...
      l(K, N, {
        ...
        process: function (e) {
          var t = this.options,
            ...
            n = e.distance < t.threshold,
            s = e.deltaTime < t.time;
          if ((this.reset(), e.eventType & ye && 0 === this.count))
      ...
      recognize: function (e) {
        ...
        if (!t.stopped) {
          ...
          for (var s = 0; s < n.length; )
            (i = n[s]),
              2 === t.stopped || (a && i != a && !i.canRecognizeWith(a))
                ? i.reset()
                : i.recognize(e),
  ...
  (function () {
    ...
    e.prototype = {
      ...
      volume: function (e) {
        var i = this || t;
        if (
          ((e = parseFloat(e)), i.ctx || d(), void 0 !== e && e >= 0 && e <= 1)
        ) {
          ...
          for (var n = 0; n < i._howls.length; n++)
            if (!i._howls[n]._webAudio)
              for (
                var a = i._howls[n]._getSoundIds(), s = 0;
                s < a.length;
                s++
              ) {
      ...
      _setupCodecs: function () {
        ...
        return (
          (e._codecs = {
            ...
            weba: !(
              d ||
              !i.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/, "")
            ),
            webm: !(
              d ||
              !i.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/, "")
          ...
          var i = function (t) {
            ...
            for (var a = 0; a < e._howls.length; a++)
              if (!e._howls[a]._webAudio)
                for (
                  var s = e._howls[a]._getSoundIds(), r = 0;
                  r < s.length;
                  r++
                ) {
    ...
    i.prototype = {
      ...
      play: function (e, i) {
        ...
        if (!o) return null;
        if (
          (a && !e && (e = o._sprite || "__default"), "loaded" !== n._state)
        ) {
        ...
        if (!(d >= h)) {
          ...
          if (n._webAudio) {
            var g = function () {
              ...
              m.gain.setValueAtTime(e, t.ctx.currentTime),
                ...
                void 0 === m.bufferSource.start
                  ? o._loop
                    ? m.bufferSource.noteGrainOn(0, d, 86400)
                    : m.bufferSource.noteGrainOn(0, d, c)
                  : o._loop
                  ? m.bufferSource.start(0, d, 86400)
                  : m.bufferSource.start(0, d, c),
                p !== 1 / 0 &&
            ...
            "running" === t.state && "interrupted" !== t.ctx.state
              ? g()
              : ((n._playLock = !0), n.once("resume", g), n._clearTimer(o._id));
          } else {
            var v = function () {
              (m.currentTime = d),
      ...
      volume: function () {
        ...
        if (1 === s.length || (2 === s.length && void 0 === s[1])) {
          ...
          s.length >= 2 && ((e = parseFloat(s[0])), (i = parseInt(s[1], 10)));
        if (!(void 0 !== e && e >= 0 && e <= 1))
      ...
      _stopFade: function (e) {
        ...
        return (
          n &&
            n._interval &&
            (i._webAudio &&
              n._node.gain.cancelScheduledValues(t.ctx.currentTime),
          ...
          (i = n._soundById(s[r])) &&
            ...
            n._webAudio &&
              ...
              e &&
                ...
                n.playing(s[r]) && (n.pause(s[r], !0), n.play(s[r], !0)))));
        return n;
      },
      rate: function () {
        var e,
        ...
        if (0 === s.length) i = a._sounds[0]._id;
          ...
          2 === s.length && ((e = parseFloat(s[0])), (i = parseInt(s[1], 10)));
        if ("number" != typeof e)
      ...
      seek: function () {
        ...
        if (0 === a.length) n._sounds.length && (i = n._sounds[0]._id);
          ...
          r >= 0
            ? (i = parseInt(a[0], 10))
            : n._sounds.length &&
              ((i = n._sounds[0]._id), (e = parseFloat(a[0])));
        } else
          2 === a.length && ((e = parseFloat(a[0])), (i = parseInt(a[1], 10)));
      ...
      unload: function () {
        ...
        for (n = 0; n < t._howls.length; n++)
          if (
            t._howls[n]._src === e._src ||
            e._src.indexOf(t._howls[n]._src) >= 0
          ) {
            r = !1;
            break;
          }
      ...
      on: function (e, t, i, n) {
        ...
        return (
          "function" == typeof t &&
            a.push(n ? { id: i, fn: t, once: n } : { id: i, fn: t }),
          this
        );
      },
      off: function (e, t, i) {
      ...
      _clearTimer: function (e) {
        ...
        if (t._endTimers[e]) {
          if ("function" != typeof t._endTimers[e])
            ...
            i &&
              i._node &&
              i._node.removeEventListener("ended", t._endTimers[e], !1);
          }
        ...
        if (!(e._sounds.length < t)) {
          ...
          for (n = e._sounds.length - 1; n >= 0; n--) {
            ...
            e._sounds[n]._ended &&
              (e._webAudio &&
                e._sounds[n]._node &&
                e._sounds[n]._node.disconnect(0),
    ...
    var a = {},
      s = function (e) {
        ...
        if (/^data:[^;]+;base64,/.test(t)) {
          for (
            var i = atob(t.split(",")[1]), n = new Uint8Array(i.length), s = 0;
            s < i.length;
            ++s
          )
            n[s] = i.charCodeAt(s);
  ...
  (function () {
    ...
    (HowlerGlobal.prototype._pos = [0, 0, 0]),
          ...
          "number" != typeof e
            ...
            : ((r._orientation = [e, t, i, n, a, s]),
              void 0 !== r.ctx.listener.forwardX
                ? (r.ctx.listener.forwardX.setTargetAtTime(
                    e,
                    Howler.ctx.currentTime,
                    0.1
                  ),
                  r.ctx.listener.forwardY.setTargetAtTime(
                    t,
                    Howler.ctx.currentTime,
                    0.1
                  ),
                  r.ctx.listener.forwardZ.setTargetAtTime(
                    i,
                    Howler.ctx.currentTime,
                    0.1
                  ),
                  r.ctx.listener.upX.setTargetAtTime(
                    n,
                    Howler.ctx.currentTime,
                    0.1
                  ),
                  r.ctx.listener.upY.setTargetAtTime(
                    a,
                    Howler.ctx.currentTime,
                    0.1
                  ),
                  r.ctx.listener.upZ.setTargetAtTime(
                    s,
                    Howler.ctx.currentTime,
                    0.1
                  ))
      ...
      (Howl.prototype.orientation = function (e, i, n, a) {
        ...
        if (
          ((i = "number" != typeof i ? s._orientation[1] : i),
      ...
      (Howl.prototype.pannerAttr = function () {
        ...
        if (1 === s.length) {
          if ("object" != typeof s[0])
            return (n = a._soundById(parseInt(s[0], 10)))
              ? n._pannerAttr
              : a._pannerAttr;
          (e = s[0]),
            void 0 === i &&
            ...
            l = {
              ...
              coneOuterAngle:
                void 0 !== e.coneOuterAngle
                  ...
                  : l.coneOuterAngle,
              coneOuterGain:
                void 0 !== e.coneOuterGain ? e.coneOuterGain : l.coneOuterGain,
              distanceModel:
                void 0 !== e.distanceModel ? e.distanceModel : l.distanceModel,
              maxDistance:
                void 0 !== e.maxDistance ? e.maxDistance : l.maxDistance,
              refDistance:
                void 0 !== e.refDistance ? e.refDistance : l.refDistance,
              rolloffFactor:
                void 0 !== e.rolloffFactor ? e.rolloffFactor : l.rolloffFactor,
              panningModel:
                void 0 !== e.panningModel ? e.panningModel : l.panningModel,
            };
            var d = n._panner;
            d
      ...
      (Sound.prototype.init = (function (e) {
        return function () {
          ...
          (t._orientation = i._orientation),
            ...
            t._stereo
              ? i.stereo(t._stereo)
              : t._pos && i.pos(t._pos[0], t._pos[1], t._pos[2], t._id);
        };
        ...
        return function () {
          ...
          return (
            ...
            t._stereo
              ? i.stereo(t._stereo)
              : t._pos
              ? i.pos(t._pos[0], t._pos[1], t._pos[2], t._id)
              : t._panner &&
  ...
  (function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
      ...
      ? define(t)
      : ((e =
          "undefined" != typeof globalThis ? globalThis : e || self).SiriWave =
          t());
  })(this, function () {
    "use strict";
    /*! *****************************************************************************
      ...
      t = (function () {
        ...
        return (
          (e.prototype.globalAttFn = function (e) {
            return Math.pow(
              this.ATT_FACTOR /
                (this.ATT_FACTOR + Math.pow(e, this.ATT_FACTOR)),
              this.ATT_FACTOR
            );
          }),
          ...
          (e.prototype.yPos = function (e) {
            return (
              ...
              (this.globalAttFn(e) *
                ...
                Math.sin(this.ctrl.opt.frequency * e - this.ctrl.phase))
            );
          }),
      ...
      i = (function () {
        ...
        return (
          ...
          (e.prototype.spawnSingle = function (e) {
            (this.phases[e] = 0),
              (this.amplitudes[e] = 0),
              (this.despawnTimeouts[e] = this.getRandomRange(
              ...
              (this.finalAmplitudes[e] = this.getRandomRange(
          ...
          (e.prototype.globalAttFn = function (e) {
            return Math.pow(
              this.ATT_FACTOR / (this.ATT_FACTOR + Math.pow(e, 2)),
              this.ATT_FACTOR
            );
          }),
          ...
          (e.prototype.yRelativePos = function (e) {
            for (var t = 0, i = 0; i < this.noOfCurves; i++) {
              ...
              t += Math.abs(
                this.amplitudes[i] *
                  this.sin(this.verses[i] * a, this.phases[i]) *
                  this.globalAttFn(a)
              );
            }
          ...
          (e.prototype.yPos = function (e) {
            return (
              ...
              this.ctrl.amplitude *
              this.yRelativePos(e) *
              this.globalAttFn((e / this.GRAPH_X) * 2)
            );
          }),
          (e.prototype.xPos = function (e) {
            return this.ctrl.width * ((e + this.GRAPH_X) / (2 * this.GRAPH_X));
          ...
          (e.prototype.drawSupportLine = function () {
            ...
            i.addColorStop(0, "transparent"),
              i.addColorStop(0.1, "rgba(255,255,255,.5)"),
              i.addColorStop(0.8, "rgba(255,255,255,.5)"),
          ...
          (e.prototype.draw = function () {
            ...
            for (var t = 0; t < this.noOfCurves; t++)
              this.spawnAt + this.despawnTimeouts[t] <= Date.now()
                ? (this.amplitudes[t] -= this.DESPAWN_FACTOR)
                : (this.amplitudes[t] += this.DESPAWN_FACTOR),
                (this.amplitudes[t] = Math.min(
                  Math.max(this.amplitudes[t], 0),
                  this.finalAmplitudes[t]
                )),
                (this.phases[t] =
                  (this.phases[t] +
                    this.ctrl.speed * this.speeds[t] * this.SPEED_FACTOR) %
                  (2 * Math.PI));
            ...
            return (
              i < this.DEAD_PX && this.prevMaxY > i && (this.spawnAt = 0),
              (this.prevMaxY = i),
              null
            );
          }),
    ...
    return (function () {
      function n(n) {
        ...
        if (
          ...
          this.curves = (this.opt.curveDefinition || t.getDefinition()).map(
            function (e) {
              return new t(a, e);
            }
          );
      ...
      return (
        (n.prototype.hex2rgb = function (e) {
          ...
          return t
            ? parseInt(t[1], 16).toString() +
                "," +
                parseInt(t[2], 16).toString() +
                "," +
                parseInt(t[3], 16).toString()
            : null;
        }),
        ...
        (n.prototype.lerp = function (e) {
          ...
          return (
            null !== t &&
              ((this[e] = this.intLerp(this[e], t, this.opt.lerpSpeed)),
        ...
        (n.prototype.start = function () {
          ...
          (this.phase = 0),
            this.run || ((this.run = !0), this.startDrawCycle());
        }),
