...
!(function (t) {
  ...
  function T(t, e, n, r) {
    return (
      (t = { effect: (t = d.isPlainObject(t) ? (e = t).effect : t) }),
              ...
              (this.diff = (function (t, e) {
                ...
                for (n in e)
                  (r = e[n]),
                    t[n] !== r &&
                      (x[n] ||
                        (!d.fx.step[n] && isNaN(parseFloat(r))) ||
                        (o[n] = r));
                return o;
              })(this.start, this.end)),
              this
  ...
  d.effects,
    d.effects.define("slide", "show", function (t, e) {
      ...
      d.effects.createPlaceholder(o),
        ...
        "show" === s &&
          (o.cssClip(l.clip), o.css(c, l[c]), (l.clip = n), (l[c] = r)),
        o.animate(l, {
          queue: !1,
          duration: t.duration,
          easing: t.easing,
