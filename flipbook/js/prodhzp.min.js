"undefined" == typeof hzflip && (hzflip = {}),
  ...
  (hzflip.controls = {
    ...
    init: function (e) {
      (this.config = e),
        ...
        (null == e.disableControls ||
          (null != e.disableControls && !e.disableControls.zoom)) &&
          hzflip.controls.zoom.bindings(),
    ...
    turned: function (e) {
      hzflip.controls.zoom.turned(e),
        ...
        $(".logo-backs2").parent().is("a") &&
          null != e &&
          (1 == e ||
          (e == heyzine.config.num_pages && heyzine.config.num_pages % 2 == 0)
            ? $(".logo-backs2").css("z-index", 1)
            : $(".logo-backs2").css("z-index", 0));
    },
    turning: function (e) {
          ...
          (e.onload = function () {
            heyzine.stats.trackControls("print"),
              e.contentWindow.postMessage(
                JSON.stringify({ action: "print", url: t }),
                i
              );
          }),
    ...
    loadUserBookmarks: function () {
      if (0 == this.userBookmarks.length) {
        const e = heyzine.storage.getItem(
          "heyzine-bookmarks-" + this.config.name
        );
        null != e &&
          ((this.userBookmarks = JSON.parse(e)),
    ...
    saveUserBookmarks: function () {
      heyzine.storage.setItem(
        "heyzine-bookmarks-" + this.config.name,
        JSON.stringify(this.userBookmarks)
      );
    },
    addUserBookmark: function (e, t) {
      return (
        null != e &&
          (null == t && (t = heyzine.lang.translate.fromKey("page") + " " + e),
          this.userBookmarks.push({ title: t, page: e })),
        this.saveUserBookmarks(),
        null != e &&
          this.userBookmarkChange(
            this.userBookmarks[this.userBookmarks.length - 1]
          ),
    ...
    updateUserBookmark: function (e, t, i) {
      null != t && (this.userBookmarks[e].title = t),
        ...
        this.saveUserBookmarks(),
        (null == t && null == i) ||
          this.userBookmarkChange(this.userBookmarks[e]);
    },
    ...
    hidePanels: function (e) {
      null == e
        ? (heyzine.controls.navpanel.hide(),
    ...
    showPanelLateral: function (e) {
      ...
      if (
        ("right" == t.alignX
          ? $(e).css({ "margin-right": "0", width: "calc(100% - 40px)" })
          : $(e).css({ "margin-right": "10px", width: "calc(100% - 40px)" }),
        ...
        if (
          (1 == t.float
            ? "center" == t.alignX
              ...
              : "left" == t.alignX
              ? (i =
                  $("#pnlControls").offset().left - $("#canvas").offset().left)
              : "right" == t.alignX &&
                (i =
                  $("#pnlControls").offset().left +
                  $("#pnlControls").width() -
                  $(e).width() -
                  $("#canvas").offset().left)
            : (i =
                "left" == t.alignX || "center" == t.alignX
                  ? 20
                  : $("#pnlControls").width() - $(e).width() - 10),
          "top" == t.alignY)
        ) {
          let t =
              parseInt($("#pnlControls").get(0).style.top.replace("px", "")) +
              $("#pnlControls").height() +
              20,
          ...
          let n =
              1 == t.float
                ? 0 == heyzine.design.data.show_slider
                  ? 0
                  : heyzine.controls.toolbar.def.slider.pad
                : 0,
            o =
              parseInt(
                $("#pnlControls").get(0).style.bottom.replace("px", "")
              ) +
              $("#pnlControls").height() +
              20 +
              n,
        ...
        "top" == t.alignY
          ? ((n =
              1 == t.float
                ? $("#pnlControls").offset().top - $("#canvas").offset().top
                : 20),
            (i = $("#canvas").outerHeight() - n - 10))
          : "center" == t.alignY
          ...
          "left" == t.alignX
            ? $(e).css({
                left:
                  s +
                  parseInt(
                    $("#pnlControls").get(0).style.left.replace("px", "")
                  ) +
                  "px",
                right: "auto",
                top: "auto" != n ? n + "px" : n,
            ...
            : $(e).css({
                ...
                right:
                  s +
                  parseInt(
                    $("#pnlControls").get(0).style.right.replace("px", "")
                  ) +
                  "px",
                top: "auto" != n ? n + "px" : n,
                bottom: "auto" != o ? o + "px" : o,
    ...
    showPanel: function (e, t) {
      ...
      if (
        ...
        "horizontal" == i.direction
          ? $(t).css({ width: "calc(100% - 40px)" })
          : $(t).css({ width: "calc(100% - 70px)" }),
        "horizontal" == i.direction)
      ) {
        let n;
        n =
        ...
        if (n < $("#canvas").offset().left)
          ...
          n + $(t).width() >
          $("#canvas").offset().left + $("#canvas").width()
        ) {
          const e = parseInt(
            $("#canvas").get(0).style.paddingRight.replace("px", "")
          );
          n =
            1 == i.float
              ? $("#pnlControls").offset().left +
                $("#pnlControls").outerWidth() -
                $(t).outerWidth() -
                $("#canvas").offset().left
              : $("#canvas").outerWidth() - $(t).outerWidth() - e;
        } else n -= $("#canvas").offset().left;
        if ((n < 0 && (n = 20), "top" == i.alignY))
          $(t).css({
            left: n + "px",
            right: "auto",
            top:
        ...
        n < $("#canvas").offset().top
          ...
          ? (n = $("#canvas").height() - $(t).outerHeight() - 20)
          : (n -= $("#canvas").offset().top),
          n < 0 && (n = 20),
          "left" == i.alignX
            ? $(t).css({
  ...
  (hzflip.controls.fullscreen = {
    ...
    bindings: function () {
      $(".fullscreen-button").on("click", function () {
        return (
          !scaler.isInIframe() ||
          (hzflip.controls.fullscreen.isSupported() &&
            !hzflip.controls.fullscreen.isTopInFullscreen())
            ? hzflip.controls.fullscreen.toggle()
            : hzflip.controls.fullscreen.toggleMessage(),
    ...
    isSupported: function () {
      var e = document,
        t = !0;
      $("#canvas").parent().is("body") ||
        ((e = $("#canvas").parent().get(0)), (t = !1));
      var i = e;
      return (
    ...
    isTopInFullscreen: function () {
      try {
        return (
          top.document.fullscreenElement &&
          null !== top.document.fullscreenElement &&
          ("HTML" == top.document.fullscreenElement.tagName ||
            "BODY" == top.document.fullscreenElement.tagName)
        );
      } catch (e) {
        return !1;
      }
    ...
    toggleMessage: function () {
      $(".fullscreen-button").hasClass("hz-icn-fullscreen-on")
        ? ($(".fullscreen-button")
            .removeClass("hz-icn-fullscreen-on")
            .addClass("hz-icn-fullscreen-off"),
        ...
        : ($(".fullscreen-button")
            .removeClass("hz-icn-fullscreen-off")
            .addClass("hz-icn-fullscreen-on"),
          window.parent.postMessage(
            {
              action: "heyzineFullscreen",
              value: !1,
    ...
    toggle: function () {
      if (!this.isEditMode) {
        ...
        if (
          ($("#canvas").parent().is("body") ||
            ((e = $("#canvas").parent().get(0)), (t = !1)),
          (e.fullScreenElement && null !== e.fullScreenElement) ||
  ...
  (hzflip.controls.navigation = {
    ...
    bindings: function (e) {
      ...
      (t.numPages = e.num_pages),
        (t.hashNavigation =
          null == e.hashNavigation || !1 !== e.hashNavigation),
        t.inited ||
          ((t.inited = !0),
          (null != heyzine.design.data.embed_mode &&
            1 == heyzine.design.data.embed_mode) ||
            $(document).keydown(function (e) {
              ...
              switch (
                (null != heyzine.viewer &&
                  "SWIPER" == heyzine.viewer.viewerName &&
                  1 == heyzine.design.data.viewer_dir &&
                  ((i = 38), (n = 40)),
                e.keyCode)
              ) {
                case i:
                  1 == heyzine.design.data.rtl
                    ? t.goToPage("next", "keyboard")
                    : t.goToPage("previous", "keyboard"),
                    e.preventDefault();
                  break;
                case n:
                  1 == heyzine.design.data.rtl
          ...
          $(document)
            .on("click", ".btnNext", function (e) {
              1 == heyzine.design.data.rtl
                ? t.goToPage("previous", "button")
                : t.goToPage("next", "button");
            })
          ...
          $(document).on("click", "#btnNavPrev", function () {
            return (
              1 == heyzine.design.data.rtl
                ? t.goToPage("next", "button-nav")
                : t.goToPage("previous", "button-nav"),
              heyzine.firstInteraction(),
              !1
            );
          }),
          ...
          $(document).on("click", "#btnNavStart", function () {
            let e =
              "" == $.trim(heyzine.design.data.start_page)
                ? 1
                : heyzine.design.data.start_page;
            return (
              1 == heyzine.design.data.rtl &&
                (e =
                  "" == $.trim(heyzine.design.data.end_page)
                    ? t.numPages
                    : heyzine.design.data.end_page),
          ...
          $(document).on("mouseleave", ".page-depth", function (e) {
            $(".page-depth-label").hide(),
              null != t.tmrPageDepthLabel &&
                ((t.pageDepthPage = null), clearTimeout(t.tmrPageDepthLabel));
          }),
          $(document).on("mousemove", ".page-depth", function (e) {
            if (!t.enabled) return;
            if (1 != heyzine.getZoomScale())
              return (
                $(".page-depth-label").hide(), void (t.pageDepthPage = null)
              );
            let i = 0;
            ...
            if (1 == heyzine.design.data.rtl)
              if ($(this).hasClass("page-depth-right")) {
                const t = Math.abs($(this).css("right").replace("px", "")),
                  i = Math.abs(
                    $(this).offset().left + ($(this).width() - t) - e.pageX
                  ),
                  s = n[0] - 1,
                  a = 1,
                  l = t;
          ...
          $(document).on("click", ".page-depth", function (e) {
            null != t.pageDepthPage &&
              t.goToPage(t.pageDepthPage, "button-nav");
          }),
          t.hashNavigation &&
    ...
    turned: (e) => {
      ...
      t.showHide(e),
        ...
        "undefined" != typeof Hash &&
        t.firstTurned &&
        null == heyzine.browserNavButtons
          ? Hash.go("page/" + e).update()
          : (t.firstTurned = !0);
    },
    turning: (e) => {
      var t = hzflip.controls.navigation;
    ...
    showHide: (e) => {
      3 != heyzine.design.data.arrows &&
        (1 == heyzine.design.data.rtl
          ? (1 == e ? $(".next-button").hide() : $(".next-button").show(),
            heyzine.isLastPage(e)
  ...
  (hzflip.controls.slider = {
    ...
    isSinglePage: function () {
      return (
        ...
        2 == heyzine.design.data.show_double
      );
    },
    bindings: function (e) {
      if ($(".page-bar").length <= 0 || 0 == heyzine.design.data.show_slider)
        return;
      1 == heyzine.design.data.rtl
        ? $(".page-bar input[type=range]").css("direction", "rtl")
        : $(".page-bar input[type=range]").css("direction", "ltr");
      const t =
          null == heyzine.design.data.show_slider ||
          1 == heyzine.design.data.show_slider ||
          3 == heyzine.design.data.show_slider,
        i =
          2 == heyzine.design.data.show_slider ||
          3 == heyzine.design.data.show_slider;
      var n = hzflip.controls.slider;
      (this.config = e),
        (n.numPages = e.num_pages),
        $(".page-bar input[type=range]").attr("min", 1),
        $(".page-bar input[type=range]").attr(
          "max",
          n.isSinglePage()
            ? n.numPages
            : n.numPages % 2 == 0
            ? Math.floor((n.numPages - 2) / 2) + 2
            : Math.floor(n.numPages / 2) + 1
        ),
        i
          ? $(".page-bar .page-bar-value").addClass("page-bar-num-enabled")
          : $(".page-bar .page-bar-value").removeClass("page-bar-num-enabled"),
        $(".page-bar input[type=range]").on("input mousedown", function () {
          if (((n.drag = !0), t)) {
            ...
            !0 === heyzine.config.toc ? (e = 1) : $(".page-bar-value").hide(),
              ...
              n
                .thumbnails(
                  $(this).parent().find("span.page-bar-value"),
                  $(this).val(),
                  e
                )
                .then(() => {
          ...
          if (i) {
            ...
            null == e[1]
              ? $("span.page-bar-num").html(e[0])
              : $("span.page-bar-num").html(e[0] + " - " + e[1]),
  ...
  (hzflip.controls.zoom = {
    ...
    bindings: function () {
      ...
      (null != heyzine.design.data.embed_mode &&
        1 == heyzine.design.data.embed_mode) ||
      (0 == heyzine.design.data.show_zoom &&
        0 == heyzine.design.data.click_zoom)
        ? (this.isZoomDisabled = !0)
        : (this.isZoomDisabled = !1),
      ...
      (this.hammer = new Hammer.Manager($("#canvas").get(0), {
        recognizers: [[Hammer.Pinch, { enable: t }]],
      })),
      ...
      this.hammer.add([n, i]),
        ...
        $("#canvas").on("touchmove", (e) => {
          $(e.target)
            .closest(".layer-action-render")
            .hasClass("layer-disable-page-drag") ||
            this.moveProgress(e.touches[0].pageX, e.touches[0].pageY);
        }),
        ...
        $("#canvas").on("mousemove", (e) => {
          $(e.target)
            .closest(".layer-action-render")
            .hasClass("layer-disable-page-drag") ||
            this.moveProgress(e.pageX, e.pageY);
        }),
        this.hammer.on("pinch", function (t) {
          if (!e.isEditMode && !e.isZoomDisabled) {
            ...
            e.zoomSet(
              { size: e.state.pinchScale + i, animate: !1 },
              {
        ...
        $("#canvas").mousewheel(function (t, i) {
          ...
          return (
            !(
              !scaler.isInIframe() ||
              !scaler.isParentDifferentDomain() ||
              e.isInFullScreen
            ) ||
            !(
              !scaler.isInIframe() ||
            ...
            (e.isEditMode ||
              ...
              ((2 == n && !o) || (1 == n && o)) &&
                (e.isZoomIn
                  ? (e.moveStart(t.pageX, t.pageY),
                    i > 0
                      ? e.moveProgress(t.pageX, t.pageY + 30)
                      : e.moveProgress(t.pageX, t.pageY - 30),
                    e.moveEnd())
                  : (null == e.delayTimer ||
                      new Date().getTime() - e.delayTimer > 300) &&
                    (i > 0
                      ? hzflip.controls.goToPage("previous", "button-nav")
                      : hzflip.controls.goToPage("next", "button-nav"),
        ...
        $(".zoom-icon").on("click", function () {
          return (
            e.isEditMode ||
              e.isZoomDisabled ||
              (e.isZoomIn ? e.zoomReset() : e.zoomCenter()),
            heyzine.firstInteraction(),
            !1
          );
        }),
        this.hammer.on("singletap", function (t) {
          ...
          (null != $(t.target).parent().parent() &&
            "pnlControls" == $(t.target).parent().parent().attr("id")) ||
        ...
        this.hammer.on("doubletap", function (t) {
          e.preventDoubleTap ||
            ...
            "true" ===
              $(t.target)
                .closest("[data-disable-zoom]")
                .attr("data-disable-zoom") ||
            (0 != heyzine.design.data.click_zoom &&
              (e.isEditMode ||
                e.isZoomDisabled ||
                (e.isZoomIn ? e.zoomReset() : e.zoomCenter()),
    ...
    onFullScreen: function (e) {
      (this.isInFullScreen = e),
        scaler.isInIframe() && this.hammer.get("pinch").set({ enable: e });
    },
    ...
    moveProgress: function (e, t) {
      ...
      if (i.dragging) {
        ...
        for (let e = 0; e < g.length; e++)
          (null == h ||
            h > $('#magazineViewport [page="' + g[e] + '"]').offset().left) &&
            (h = $('#magazineViewport [page="' + g[e] + '"]').offset().left),
            (null == d ||
              d > $('#magazineViewport [page="' + g[e] + '"]').offset().top) &&
              (d = $('#magazineViewport [page="' + g[e] + '"]').offset().top),
            (null == p ||
              p <
                $('#magazineViewport [page="' + g[e] + '"]').offset().top +
                  $('#magazineViewport [page="' + g[e] + '"]').height() *
                    this.state.scale) &&
              (p =
                $('#magazineViewport [page="' + g[e] + '"]').offset().top +
                $('#magazineViewport [page="' + g[e] + '"]').height() *
            ...
            (null == c ||
              c <
                $('#magazineViewport [page="' + g[e] + '"]').offset().left +
                  $('#magazineViewport [page="' + g[e] + '"]').width() *
                    this.state.scale) &&
              (c =
                $('#magazineViewport [page="' + g[e] + '"]').offset().left +
                $('#magazineViewport [page="' + g[e] + '"]').width() *
    ...
    setZoom: function (e, t, i) {
      this.isEditMode ||
        ...
        ("zoomIn" == e
          ...
          : "zoomOut" == e
          ? this.zoomReset()
          : "zoomLayer" == e && this.zoomToLayer("#layer" + t, i));
    },
    zoomToLayer: function (e, t) {
      ...
      (n *= i),
        this.zoomSet(
          ...
          { x: $(e).offset().left, y: $(e).offset().top },
          () => {
            let t =
                -$(e).offset().left / n +
                ($("#canvas").width() + $("#canvas").offset().left) / n / 2 -
                $(e).width() / 2,
              i =
                -$(e).offset().top / n +
                ($("#canvas").height() + $("#canvas").offset().top) / n / 2 -
                $(e).height() / 2;
    ...
    zoomCenter: function (e, t) {
      ...
      const i = null != e ? e : 1,
        n = null != t ? t : 1.5;
      this.zoomSet(
        { dir: i, increment: n, animate: "animated" },
    ...
    zoomSet: function (e, t, i) {
      ...
      if (
        ((this.state.xImage =
          this.state.xImage + (n - this.state.xLast) / this.state.scale),
        (this.state.yImage =
          this.state.yImage + (o - this.state.yLast) / this.state.scale),
        this.state.scale > 1
          ? this.setZoomInControls()
          : this.setZoomOutControls(),
        e.size)
      )
        1 == this.state.scale &&
          e.size > 1 &&
          (this.setZoomInControls(), heyzine.setZoomViewer("zoomIn")),
      ...
      (r.scale = this.state.scale),
        ...
        1 == this.state.scale
          ...
          : (e.animate
              ? $("#magazineViewport").addClass(e.animate)
              : $("#magazineViewport").removeClass("animated"),
            $("#magazineViewport").css(
              "transform",
              "scale(" +
            ...
            e.animate
              ? $("#magazineViewport").one("transitionend", () => {
                  t.noRender || this.renderPages(),
                    null != i
                      ? i()
                      : $("#magazineViewport").removeClass(e.animate);
                })
    ...
    setZoomInControls: function () {
      (this.isZoomIn = !0),
        ...
        0 != heyzine.design.data.show_slider &&
          $(".control-bottom .page-bar").hide(),
        heyzine.stats.trackControls("zoom-in"),
        $(".zoom-icon").removeClass("zoom-icon-in").addClass("zoom-icon-out"),
        $(".layer-zoom")
          .removeClass("layer-zoom-in")
          .addClass("layer-zoom-out"),
    ...
    setZoomOutControls: function () {
      (this.isZoomIn = !1),
        ...
        0 != heyzine.design.data.show_slider &&
          $(".control-bottom .page-bar").fadeIn(),
        heyzine.progressBar("cancel"),
        $(".zoom-icon").removeClass("zoom-icon-out").addClass("zoom-icon-in"),
        $(".layer-zoom")
          .removeClass("layer-zoom-out")
          .addClass("layer-zoom-in"),
        $("#pnlZoomStep").fadeOut("fast"),
        3 != heyzine.design.data.arrows &&
          ($(".btnPrevious").fadeIn("fast"), $(".btnNext").fadeIn("fast")),
  ...
  (hzflip.controls.sound = {
    ...
    bindings: function () {
      $("#btnSoundOff").on(
        ...
        () => (
          ...
          this.isSoundEnabled
            ? ($("#btnSoundOff")
                .addClass("hz-icn-sound-on")
                .removeClass("hz-icn-sound-off"),
              heyzine.stats.trackControls("sound-on"))
            : ($("#btnSoundOff")
                .removeClass("hz-icn-sound-on")
                .addClass("hz-icn-sound-off"),
    ...
    peelStart: function (e) {
      null != heyzine.design &&
        null != heyzine.design.data &&
        null != heyzine.design.data.sound_flip &&
        (this.isPageTurnSound =
          !0 === heyzine.design.data.sound_flip ||
          1 == heyzine.design.data.sound_flip),
        this.isSoundEnabled &&
          this.isPageTurnSound &&
          Howler &&
  ...
  (hzflip.controls.share = {
    ...
    bindings: function () {
      ...
      $("#btnShare").on(
        "click",
        () => (this.toggleShow(), heyzine.firstInteraction(), !1)
      ),
        ...
        $(".selPageSelector").on("click", () => {
          $(".selPageDropDown").is(":visible")
            ? $(".selPageDropDown").hide()
            : $(".selPageDropDown").show();
        }),
        $(".selPageDropDown").on("click", "div", function (t) {
          let i = $(this).text();
          1 != i
            ? ($(".selPageSelected").show(),
              $(".selPageEmpty").hide(),
    ...
    setPage: function (e) {
      this.currentPage &&
        (this.setLink(e), $(".selPageSelected").html("p" + e));
    },
    setLink: function (e) {
      let t = "";
      if (
        (1 != e && null != e && (t = "#page/" + e),
        heyzine.config &&
          heyzine.config.domain &&
          heyzine.config.domain.indexOf(document.location.host) >= 0)
      ) {
        const e =
          "https://heyzine.com" == heyzine.config.domain ? "/flip-book" : "";
        this.link =
          heyzine.config.domain + e + "/" + heyzine.config.custom_name + t;
      } else {
    ...
    socialOpen: function (e, t) {
      "facebook" == e &&
        heyzine.navigate(
          "https://www.facebook.com/sharer.php?u=" + encodeURI(t),
          "newtab"
        ),
        "twitter" == e &&
          heyzine.navigate(
            "https://twitter.com/intent/tweet?url=" + encodeURI(t),
            "newtab"
          ),
        "linkedin" == e &&
          heyzine.navigate(
        ...
        "whatsapp" == e &&
          heyzine.navigate("https://wa.me/?text=" + encodeURI(t), "newtab"),
        "telegram" == e &&
          heyzine.navigate(
            "https://t.me/share/url?url=" + encodeURI(t),
            "newtab"
          ),
        "pinterest" == e &&
          heyzine.navigate(
            "https://www.pinterest.com/pin/create/button/?url=" + encodeURI(t),
            "newtab"
          ),
        "messenger" == e &&
          heyzine.navigate(
            "https://www.facebook.com/dialog/send?app_id=887549652630742&link=" +
              encodeURI(t) +
              "&redirect_uri=" +
              encodeURI(t),
            "newtab"
        ...
        "email" == e &&
          heyzine.navigate("mailto://?body=" + encodeURI(t), "newtab");
    },
    clipboard: {
      copy: function (e) {
        navigator.clipboard
      ...
      copyRaw: function (e) {
        ...
        document.createRange
          ? ((t = document.createRange()).selectNode(e),
  ...
  (hzflip.controls.toolbar = {
    def: {
      ...
      canvas: {
        horizontal: function () {
          return 2 == heyzine.design.data.show_outline ||
            3 == heyzine.design.data.show_outline ||
            2 == heyzine.design.data.show_bookmarks ||
            3 == heyzine.design.data.show_bookmarks
            ? 38
            : $(window).width() < 790
            ? 10
            : 20;
      ...
      arrows: function () {
        return 3 != heyzine.design.data.arrows && $(window).width() > 750
          ? 1 == heyzine.design.data.arrows
            ? 32
            : 14
          : 0;
      },
    ...
    setDisposition: function (e) {
      ...
      $("#pnlControls").attr("style", t.controls_style),
        ("100%" != $("#pnlControls").get(0).style.width &&
          "100%" != $("#pnlControls").get(0).style.height) ||
          $("#pnlControls").css("border-radius", 0),
        $("#pnlControls")
          .removeClass("controls-disp-bottom")
          .removeClass("controls-disp-top")
          .removeClass("controls-disp-center"),
        $("#pnlControls")
          .removeClass("controls-disp-fx-v-l")
          .removeClass("controls-disp-fx-v-r"),
        "top" == i.alignY
          ? $("#pnlControls").addClass("controls-disp-top")
          : "center" == i.alignY
          ? $("#pnlControls").addClass("controls-disp-center")
          : $("#pnlControls").addClass("controls-disp-bottom"),
        "vertical" == i.direction &&
          0 == i.float &&
          ("right" == i.alignX
            ? $("#pnlControls").addClass("controls-disp-fx-v-r")
            : $("#pnlControls").addClass("controls-disp-fx-v-l")),
        $(".controls-pdf").css(
          "background-color",
          $("#pnlControls").css("background-color")
        ),
        0 != t.show_slider && this.setSliderDisposition(i, !0),
        this.setTitleDisposition(i),
        this.setCanvasDisposition(i),
        $("#pnlControls").hasClass("panel-controls-hidden") &&
          $("#pnlControls").hide();
    },
    setCanvasDisposition: function (e) {
      ...
      if (0 == e.float && "horizontal" == e.direction) {
        const o =
            ($("#pnlControls").is(":visible")
              ? $("#pnlControls").outerHeight()
              : 0) + i,
          s =
            0 == heyzine.design.data.show_slider || this.sliderInBar
              ? 0
              : this.def.slider.pad;
        "top" == e.alignY
          ? $("#canvas").css({
        ...
        const e =
          0 == heyzine.design.data.show_slider ? 0 : this.def.slider.pad;
        $("#canvas").css({
          "padding-left": t + n + "px",
          "padding-right": t + n + "px",
          "padding-top": i + "px",
      ...
      if ($(".flipbook-title").is(":visible")) {
        ...
        if (($(".flipbook-title").css({ top: "", left: "" }), 0 == e.float))
          ...
          if ("vertical" == e.direction) {
            let e = n;
            const t = this.parseLogoStyle(
              heyzine.design.data.company_logo_style
            );
            "top" == t.position[0] &&
              "left" == t.position[1] &&
              (e += $(".logo-backs2").height() + i),
              $(".flipbook-title").css({ top: e + "px", left: l + a + "px" });
          } else $(".flipbook-title").css({ top: r + "px", left: t + "px" });
        else
          "center left" == e.position || "bottom left" == e.position
            ? $(".flipbook-title").css({
                top: this.def.vertical + "px",
                left: t + "px",
              })
            : $(".flipbook-title").css({ top: this.def.vertical + "px" });
        const h =
          $(window).width() -
          $(".flipbook-title").offset().left -
          $("#canvas").offset().left -
          10;
    ...
    setZoomStepDisposition: function (e) {
      "horizontal" == e.direction
        ? ("top" == e.alignY
            ? $("#pnlZoomStep").css({ top: "100px", bottom: "auto" })
            : $("#pnlZoomStep").css({ top: "auto", bottom: "100px" }),
          "left" == e.alignX
            ? $("#pnlZoomStep").css({
        ...
        : ("bottom" == e.alignY
            ? $("#pnlZoomStep").css({ top: "auto", bottom: this.def.vertical })
            : $("#pnlZoomStep").css({ top: this.def.vertical, bottom: "auto" }),
          "left" == e.alignX
            ? $("#pnlZoomStep").css({ left: "auto", right: this.def.zoom() })
            : $("#pnlZoomStep").css({ left: this.def.zoom(), right: "auto" }));
    },
    setSliderDisposition: function (e, t) {
      if (
        0 != $(".control-bottom").length &&
        ((this.sliderInBar = t),
        ($("#pnlControls .slider-vertical").length > 0 ||
          $("#pnlControls .slider-horizontal").length > 0) &&
          ($(".control-bottom").appendTo("#magazineViewport"),
        ...
        if ("vertical" == e.direction) {
          ...
          "bottom right" == e.position || "bottom left" == e.position
            ? t.prependTo("#pnlControls")
            : t.appendTo("#pnlControls"),
            "right" == e.alignX
              ? t.addClass("sliderbar-right")
              : t.addClass("sliderbar-left"),
            $(".control-bottom").appendTo(t);
        } else if ("horizontal" == e.direction) {
          let t = $('<div class="slider-toolbar slider-horizontal">');
          "top" == e.alignY
            ? t.addClass("sliderbar-top")
            : t.addClass("sliderbar-bottom"),
            "right" == e.alignX
              ? t.prependTo("#pnlControls")
              : t.appendTo("#pnlControls"),
            $(".control-bottom").appendTo(t);
    ...
    resizeViewport: function () {
      ...
      if ($(window).width() <= 475 || $(window).height() <= 475)
        $(".controls-pdf")
          ...
          .addClass("controls-sm");
      else if ($(window).width() <= 575 || $(window).height() <= 575)
        "sm" != heyzine.design.data.controls_size &&
          $(".controls-pdf")
            .removeClass("controls-lg")
            .removeClass("controls-sm")
            .addClass("controls-md");
      else {
        let e =
          "" != $.trim(heyzine.design.data.controls_size)
            ? heyzine.design.data.controls_size
            : "md";
        $(".controls-pdf")
          .removeClass("controls-lg")
          .removeClass("controls-md")
      ...
      if (1 == e.float) {
        if ("center" != e.alignX) {
          ...
          let o = 0;
          null != this.def &&
            null != this.def.canvas &&
            null != this.def.arrows &&
            (o = this.def.canvas.horizontal() + this.def.arrows()),
            $(".logo-backs2").css(
              n,
              -1 * o + this.def.panel.horizontal() + "px"
            );
        }
        if ("center" != e.alignY) {
      ...
      if (
        ...
        let t = 0;
        $("#pnlControls .hz-icon:visible,#pnlControls .hz-icon-2:visible").each(
          function () {
            t += $(this).height();
          }
        );
        let i =
            $("#pnlControls .hz-icon:visible").length +
            $("#pnlControls .hz-icon-2:visible").length,
          n =
            $("#pnlControls").height() -
            t -
            i * this.def.gapIcon -
        ...
        n < 200
          ...
          : (this.sliderInBar || this.setSliderDisposition(e, !0),
            ...
            $(".slider-vertical:first-child").length > 0
              ? $(".slider-vertical").css({
                  height: n + "px",
        ...
        let i = $(
            "#pnlControls .hz-icon:visible,#pnlControls .hz-icon-2:visible"
          ).length,
          n =
            $("#pnlControls").width() -
            t -
      ...
      $("#pnlControls")
        .removeClass("controls-xs-snap-top")
        .removeClass("controls-xs-snap-bottom")
        .removeClass("controls-snap"),
        "100%" != $("#pnlControls").prop("style").width &&
          (i < 0 ||
          $("#pnlControls").offset().left + $("#pnlControls").width() >
            $(window).width() ||
          ("auto" == $("#pnlControls").prop("style").right &&
            $("#pnlControls").offset().left - t >
              $(window).width() -
                $("#pnlControls").offset().left -
                $("#pnlControls").width()) ||
          ("auto" != $("#pnlControls").prop("style").right &&
            $("#pnlControls").offset().left - t <
              $(window).width() -
                $("#pnlControls").offset().left -
                $("#pnlControls").width())
            ? ($("#pnlControls").addClass("controls-snap"),
              "auto" != $("#pnlControls").prop("style").top
                ? $("#pnlControls").addClass("controls-xs-snap-top")
                : $("#pnlControls").addClass("controls-xs-snap-bottom"))
    ...
    parseStyle: function (e) {
      ...
      return (
        ...
        "translateY(-50%)" == i.transform
          ...
          ? ((n += "bottom"), (a = "bottom"))
          : "center" == i["justify-content"] &&
            ((n += "center"), (a = "center")),
        "50%" == i.left &&
        "auto" == i.right &&
        "translateX(-50%)" == i.transform
          ? ((n += " center"), (l = "center"))
    ...
    serializeStyle: function (e) {
      ...
      return (
        "top" == t[0]
          ? ((s = n), (a = "auto"))
          : "bottom" == t[0]
          ? ((s = "auto"), (a = this.def.vertical + v + "px"))
          : "center" == t[0] &&
            ((s = "50%"), (a = "auto"), (h = "translateY(-50%)")),
        "center" == t[1]
          ? ((l = "50%"), (r = "auto"), (h = "translateX(-50%)"))
          : "left" == t[1]
          ? ((l = i), (r = "auto"))
          : "right" == t[1] && ((l = "auto"), (r = i)),
        (g += "background-color:" + e.backgroundColor + ";"),
        1 == e.float
          ? "horizontal" == e.direction
            ? ((m = this.def.padding.horizontal + "px"),
              (y = this.def.padding.vertical + "px"))
            : "vertical" == e.direction &&
              ((m = this.def.padding.vertical + "px"),
              (y = this.def.padding.horizontal + "px"),
              (f = o))
          : "horizontal" == e.direction
          ? ((m = this.def.padding.fullX + "px"),
            (y = this.def.padding.vertical + "px"))
          : "vertical" == e.direction &&
            ((m = this.def.padding.vertical + "px"),
        ...
        0 == e.float
          ? ((d = "center"),
            "horizontal" == e.direction
              ? ("top" == t[0]
                  ? ((l = "0px"), (r = "0px"), (s = "0px"), (c = "100%"))
                  : "bottom" == t[0] &&
                    ((l = "0px"), (r = "0px"), (a = "0px"), (c = "100%")),
                "left" == t[1]
                  ? (d = "start")
                  : "right" == t[1]
                  ? (d = "end")
                  : "center" == t[1] && ((d = "center"), (h = "")))
              : ("top" == t[0]
                  ? (d = "start")
                  : "bottom" == t[0]
                  ? (d = "end")
          ...
          : "center" == t[1] &&
            "horizontal" == e.direction &&
            ("top" == t[0]
              ? (s = this.def.centerVertical + "px")
              : "bottom" == t[0] && (a = this.def.centerVertical + v + "px")),
        "horizontal" == e.direction
          ? (u = "row")
          : "vertical" == e.direction && (u = "column"),
    ...
    serializeLogoStyle: function (e, t) {
      let i = e.size,
        ...
        o = t.position,
        s =
          null != i ? { "max-width": -1 == i.indexOf("%") ? i + "%" : i } : {},
        a = {},
        l = {};
      const r = $("#pnlControls").is(":visible")
          ? $("#pnlControls").outerWidth()
          : 0,
        h = $("#pnlControls").is(":visible")
          ? $("#pnlControls").outerHeight()
          : 0;
      if (null != n) {
        if ("top" == n[0]) {
          let e = parseInt(
              $("#canvas").get(0).style.paddingTop.replace("px", "")
            ),
            i = 0,
            s = i;
          "left" == n[1] && $(".flipbook-title").is(":visible")
            ? (s =
                1 == t.float && "vertical" == t.direction && "top left" == o
                  ? i
                  : $(".flipbook-title").position().top +
                    $(".flipbook-title").outerHeight() +
                    25 -
                    e)
            : "horizontal" == t.direction &&
              (("left" == n[1] && "top left" == o) ||
                ("right" == n[1] && "top right" == o)) &&
              1 == t.float &&
              (s = $("#pnlControls").position().top + h + 25 - e),
            "SWIPER" == heyzine.config.viewer && (s += e),
            (l = { top: s + "px", bottom: "auto" });
        } else {
          let e = parseInt(
              $("#canvas").get(0).style.paddingBottom.replace("px", "")
            ),
            i = 0;
          if (
            1 == t.float &&
            "horizontal" == t.direction &&
            (("left" == n[1] && "bottom left" == o) ||
              ("right" == n[1] && "bottom right" == o))
          ) {
            i =
              h +
              10 +
        ...
        if ("right" == n[1]) {
          ...
          1 != t.float ||
          ("top right" != o && "bottom right" != o && "center right" != o)
            ? 0 != t.float ||
              "vertical" != t.direction ||
              ("top right" != o &&
                "bottom right" != o &&
                "center right" != o) ||
              (i += this.def.canvas.horizontal())
            : "vertical" == t.direction &&
              (("top right" == o && "top" == n[0]) ||
                ("bottom right" == o && "bottom" == n[0])) &&
              (i += r + this.def.vertical + 4),
            "SWIPER" == heyzine.config.viewer && (i += e),
          ...
          let e = parseInt(
            ...
            i = -e + this.def.horizontal();
          1 != t.float ||
          ("top left" != o && "bottom left" != o && "center left" != o)
            ? 0 != t.float ||
              "vertical" != t.direction ||
              ("top left" != o && "bottom left" != o && "center left" != o) ||
              (i += this.def.canvas.horizontal())
            : "vertical" == t.direction &&
              (("bottom left" == o && "bottom" == n[0]) ||
                ("top left" == o && "top" == n[0])) &&
              (i += r + this.def.vertical + 4),
            "SWIPER" == heyzine.config.viewer && (i += e),
  ...
  (hzflip.controls.search = {
    ...
    bindings: function () {
      ...
      $("#btnSearch").on(
        ...
        $("#pnlSearch").on(
          "wheel mousemove touchstart touchend touchmove",
          (e) => {
            e.stopPropagation();
          }
        ),
        $("#txtContentSearch").on("keypress", (e) => {
          "Enter" == e.key && $("#btnContentSearch").trigger("click"),
            $("#txtContentSearch").val() != this.lastSearch &&
              ($("#btnContentSearchCancel").hide(),
              $("#btnContentSearch").show());
        }),
            ...
            if ("Escape" != e.key) {
              if (this.isVisible) {
                ...
                if (
                  ...
                  if (
                    ($("#txtContentSearch").blur(),
                    0 == $(".panel-search-results-item.focused").length)
                  )
                    $($(".panel-search-results-item").get(0)).addClass(
                      "focused"
                    );
                  else {
                    let t = $(".panel-search-results-item");
                      ...
                      if ($(t[i]).hasClass("focused")) {
                        ...
                        $(t[i]).removeClass("focused"),
                          (n =
                            "ArrowUp" == e.key
                              ? t[i - 1 < 0 ? 0 : i - 1]
                              : t[i + 1 > t.length - 1 ? t.length - 1 : i + 1]),
                          $(n).addClass("focused"),
                          $(n).focus(),
                          ($(".panel-search-results").get(0).scrollTop =
                            $(n).get(0).offsetTop - 3 * $(n).height());
                        break;
                      }
                  }
                else
                  "Enter" == e.key &&
                    t.length > 0 &&
                    1 == $(".panel-search-results-item.focused").length &&
                    $(".panel-search-results-item.focused").trigger("click");
              }
              (e.ctrlKey || e.metaKey) &&
                70 === e.keyCode &&
                ($("#btnSearch").trigger("click"), e.preventDefault());
    ...
    toggleShow: function (e) {
      (this.isVisible = null == e ? !this.isVisible : e),
        this.isVisible
          ? (this.inited ||
              (hzflip.controls.searchProcess.init(), (this.inited = !0)),
            heyzine.controls.showPanel("#btnSearch", "#pnlSearch"),
            $("#pnlSearch").fadeIn("fast"))
          : $("#pnlSearch").hide();
    },
    destroy: function () {
      $("#btnSearch").off("click"),
            ...
            n.text
              .then((n) => {
                ...
                for (const e of n.items)
                  o.push(e.str), e.hasEOL && o.push("\n");
                const s = o.join("");
                [
                  hzflip.controls.searchProcess._pageContents[i],
                  hzflip.controls.searchProcess._pageDiffs[i],
                  hzflip.controls.searchProcess._hasDiacritics[i],
                ] = hzflip.controls.searchProcess.normalize(s);
                ...
                if (null != a && a.length > 0 && "" != $.trim(a)) {
                  ...
                  if (l.length > 0) {
                    ...
                    const r = 20,
                      ...
                      c =
                        h.substr(d, o - d) +
                        ("<strong>" + h.substr(o, n.length) + "</strong>") +
                        h.substr(o + n.length, o + n.length + r);
                    $(".panel-search-results").append(
                      ...
                      $(".panel-search-results")
                        ...
                        .sort(function (e, t) {
                          return (
                            $(e).attr("data-found-page") -
                            $(t).attr("data-found-page")
                          );
                        })
                        .appendTo(".panel-search-results"),
                      t.filter((e) => e == i).length > 0 &&
                        this.findAndHighlight(i, e);
                  }
                }
    ...
    clearHighlight: function (e) {
      null != e
        ? $(".page-wrapper[page=" + e + "] .page-cont .text-highlight").remove()
    ...
    findAndHighlight: async function (e, t) {
      if (!this.highlighting[e]) {
        ...
        ([i, n, o] = hzflip.controls.searchProcess.normalize(t.toLowerCase())),
          ...
          this.clearHighlight();
        let s =
            e - 1 < 1 ? 1 : e + 1 > heyzine.config.num_pages ? e - 2 : e - 1,
          a =
            e + 1 > heyzine.config.num_pages
              ? heyzine.config.num_pages
              : e - 1 < 1
              ? e + 2
              : e + 1;
        for (let e = s; e <= a; e++)
      ...
      return new Promise((t, i) => {
        heyzine.pdf
          ...
          .then((n) => {
            n.text
              .then((i) => {
                let o = hzflip.controls.searchProcess._updateMatches(
                    e,
                    i.items
                  ),
                  s = i.items,
    ...
    createHighlight: function (e, t, i, n, o, s, a, l) {
      ...
      if (h.length <= 0) {
        h = $(
          '<div class="text-highlight" data-highlight-id="' + r + '"></div>'
        );
        const o = hzflip.controls.searchProcess.transformMatrix(
          e.transform,
          n.transform
        );
        let s = 0,
    ...
    updateSearchBar: function () {
      ...
      $(".search-progress").css("width", e + "%"),
        ...
        $(".panel-search-results .panel-search-results-item").length <= 0 &&
          ...
          $(".panel-search-results").append(
            '<div class="panel-search-results-item panel-search-results-empty">' +
              heyzine.lang.translate.fromKey("searching") +
              "</div>"
          )),
        e >= 100 &&
          ...
          $(".panel-search-results .panel-search-results-item").length <= 0 &&
            $(".panel-search-results").append(
              '<div class="panel-search-results-item panel-search-results-empty">' +
                heyzine.lang.translate.fromKey("noresults") +
                "</div>"
            ));
    },
  ...
  (hzflip.controls.searchProcess = {
    ...
    init: function () {
      (this.DIACRITICS_EXCEPTION = new Set([
        ...
        3388, 3405, 3530, 3642, 3770, 3972, 4153, 4154, 5908, 5940, 6098, 6752,
        6980, 7082, 7083, 7154, 7155, 11647, 43014, 43052, 43204, 43347, 43456,
        43766, 44013, 3158, 3953, 3954, 3962, 3963, 3964, 3965, 3968, 3956,
      ])),
        (this.DIACRITICS_EXCEPTION_STR = [...this.DIACRITICS_EXCEPTION.values()]
          .map((e) => String.fromCharCode(e))
          .join(""));
      const e = document.createElement("canvas");
      ("undefined" == typeof PDFJSDev ||
        PDFJSDev.test("MOZCENTRAL || GENERIC")) &&
        (e.mozOpaque = !0),
        (this._layoutTextCtx = e.getContext("2d", { alpha: !1 }));
    },
    destroy: function () {
      this._layoutTextCtx &&
    ...
    normalize: function (e) {
      if (!this.normalizationRegex) {
        ...
        this.normalizationRegex = new RegExp(
          `([${e}])|(\\p{M}+(?:-\\n)?)|(\\S-\\n)|(\\n)`,
          "gum"
        );
      }
      ...
      return (
        (e = e.replace(this.SPECIAL_CHARS_REG_EXP, (e, n, o, s, a, l) =>
          n
            ...
            ? "[ ]+"
            : a
            ? this.DIACRITICS_EXCEPTION.has(a.charCodeAt(0))
              ? a
              : ""
            : t
            ? ((i = !0), `${l}\\p{M}*`)
    ...
    measureText: function (e, t, i) {
      ...
      (e === this._layoutTextLastFontSize &&
        t === this._layoutTextLastFontFamily) ||
        ((this._layoutTextCtx.font = `${e * n}px ${t}`),
    ...
    getAscent: function (e) {
      ...
      for (let e = 0, t = a.length; e < t; e += 4)
        if (a[e] > 0) {
          o =
            this.DEFAULT_FONT_SIZE - Math.floor(e / 4 / this.DEFAULT_FONT_SIZE);
          break;
        }
      if ((t.restore(), o)) {
        const t = o / (o + s);
  ...
  (hzflip.controls.form = {
    ...
    allowTurn: function (e) {
      return null != this.config.lead &&
        this.isEnabled &&
        !this.getFormSentOrSkipped() &&
        e >= this.config.lead.page
        ? ((this.pageAfterSubmit = e), this.config.lead.page)
        : e;
    },
    ...
    loadForEditor: function (e) {
      (this.config = e),
        null != this.config &&
          null != this.config.lead &&
          null != this.config.lead.page &&
          (heyzine.isVisiblePage(this.config.lead.page) && this.isEnabled
            ? (this.hide(!1), this.show(!1))
            : this.hide(!1));
    },
    hide: function (e) {
      null == e || e
    ...
    show: function (e) {
      ...
      if (
        ("blur_dark" == t.theme
          ...
          : "solid_dark" == t.theme &&
            ($(i).addClass("form-theme-solid").addClass("form-theme-dark"),
            (s = !0)),
        "" != $.trim(t.picture_url))
      ) {
        let e = "";
        (".svg" != t.picture_url.substr(-4) &&
          ".png" != t.picture_url.substr(-4)) ||
          (e = "size-limit");
        let i = s ? t.picture_url.replace(".", "-dark.") : t.picture_url;
        n.append(
          '<div class="form-lead-pic"><img src="' +
            heyzine.cdnPath +
            i +
            '" class="' +
            e +
      ...
      if (
        ("" != $.trim(t.text) &&
          $('<div class="form-lead-header"></div>').text(t.text).appendTo(o),
        null != t.fields && t.fields.length > 0 && this.addFields(o),
        1 == t.privacy)
      ) {
        o.append('<div class="form-lead-privacy"><label></label></div>');
        let e = heyzine.lang.translate
          .fromKey("privacy")
          .replace("{link}", t.privacy_link)
          .replace("{company}", t.privacy_name);
        o.find(".form-lead-privacy label").html(e),
          o
            .find(".form-lead-privacy label")
            .prepend('<input type="checkbox" id="chkFormPrivacy" />');
      }
      $(
        '<div class="form-lead-submit"><button type="button" id="btnFormSubmit" class="form-lead-button">' +
          heyzine.lang.translate.fromKey("send") +
          "</button></div>"
      ).appendTo(o),
        "" != $.trim(t.text_button) &&
          o.find("#btnFormSubmit").text(t.text_button),
        1 == t.skip &&
          (o
            .find(".form-lead-submit")
            .append(
              '<a href="" id="btnFormSkip">' +
                heyzine.lang.translate.fromKey("skip") +
                "</a>"
            ),
          "" != $.trim(t.text_skip) &&
    ...
    addFields: function (e) {
      ...
      for (let i = 0; i < t.length; i++) {
        ...
        "check" != t[i].type &&
          ((n = $(
            '<div class="form-lead-field" data-field-id="' +
              i +
              '"><label for="leadField' +
              i +
              '"></label></div>'
          ...
          "text" == t[i].type
            ...
            : "check" == t[i].type &&
              ((n = $(
                '<div class="form-lead-field form-lead-check" data-field-id="' +
                  i +
                  '"><label for="leadField' +
                  i +
                  '"></label></div>'
              ...
              n
                .find("label")
                .html(this.getMarkdownTransform(n.find("label").html())),
              n
                .find("label")
                .prepend(
                  '<input id="leadField' +
          ...
          for (let i = 1; i <= 5; i++)
            i <= e
              ...
              : $(this)
                  ...
                  .html(t);
          return (
            $(this).closest(".form-lead-field-review").attr("data-val", e),
    ...
    setFormSkipped: function () {
      this.isControlsEnabled &&
        (sessionStorage.setItem(
          "heyzine-form-lead-" + heyzine.config.name,
          "1"
        ),
        null != heyzine.tag &&
          sessionStorage.setItem("heyzine-form-lead-" + heyzine.tag, "1"));
    },
    setFormSent: function () {
      this.isControlsEnabled &&
        ...
        null != heyzine.tag &&
          heyzine.storage.setItem("heyzine-form-lead-" + heyzine.tag, "1"));
    },
    removeFormSent: function () {
      heyzine.storage.removeItem("heyzine-form-lead-" + heyzine.config.name),
        ...
        null != heyzine.tag &&
          (heyzine.storage.removeItem("heyzine-form-lead-" + heyzine.tag),
          sessionStorage.removeItem("heyzine-form-lead-" + heyzine.tag));
    },
    getFormSentOrSkipped: function () {
      let e =
        "1" ===
          heyzine.storage.getItem("heyzine-form-lead-" + heyzine.config.name) ||
        "1" ===
          sessionStorage.getItem("heyzine-form-lead-" + heyzine.config.name);
      return (
        e ||
          null == heyzine.tag ||
          (e =
            "1" ===
              heyzine.storage.getItem("heyzine-form-lead-" + heyzine.tag) ||
            "1" === sessionStorage.getItem("heyzine-form-lead-" + heyzine.tag)),
        e
      );
    },
    submitOrSkipClicked: function () {
      null != this.pageAfterSubmit &&
        (heyzine.goToPage(this.pageAfterSubmit), (this.pageAfterSubmit = null));
    },
    formBindings: function (e) {
      $("#btnFormSkip").on(
        "click",
        () => (
          this.hide(), this.setFormSkipped(), this.submitOrSkipClicked(), !1
        )
      ),
        $("#btnFormSubmit").on(
          "click",
          () => (
            this.formValidation(e) &&
              (this.isControlsEnabled && (this.sendForm(e), this.setFormSent()),
              this.hide(),
        ...
        e.find("input").on("keyup", () => {
          this.isDirty &&
            ($(e).find(".form-field-error").removeClass("form-field-error"),
            this.formValidation(e));
        }),
    ...
    formValidation: function (e) {
      ...
      e.find(".form-lead-field").each((e, n) => {
        ...
        "text" == s || "email" == s
          ...
          : "check" == s &&
            (a = $(n).find("input").is(":checked") ? "yes" : ""),
          (1 == t[o].required && "" == a) ||
          ("number" == s && "" != a && !heyzine.helpers.parser.isNumeric(a)) ||
          ("email" == s && "" != a && !heyzine.helpers.parser.isEmail(a))
      ...
      return (
        n.length > 0 &&
          (n.find("input[type=checkbox]").is(":checked") ||
            (n.addClass("form-field-error"), (i = !1))),
        i
      );
    },
  ...
  (hzflip.controls.bookmark = {
    ...
    bindings: function (e) {
      (this.sideEffectDelay = hzflip.viewers.magazine.duration),
        ...
        (this.bookmarkList =
          ...
          this.config.bookmark.list &&
          this.config.bookmark.list.length > 0
            ? this.config.bookmark.list
            : []);
      const t = this;
      $(".page-findex")
        ...
        $(".page-findex")
          ...
          .on(
            ...
            "[data-findex-ubix].page-findex-item",
            function (e) {
              let i = null == e.pageX ? e.changedTouches[0].pageX : e.pageX;
              const n = $(this)
                .closest(".page-findex")
                .hasClass("page-findex-left")
                ? "left"
                : "right";
              t.tabMouseDown = {
                x: i,
          ...
          .on(
            ...
            function (e) {
              if (1 == e.buttons || (e.touches && 1 == e.touches.length)) {
                let i = null == e.pageX ? e.changedTouches[0].pageX : e.pageX,
                  n =
                    "right" == t.slideDirection(t.tabMouseDown.side)
                      ? i - t.tabMouseDown.x
                      : t.tabMouseDown.x - i,
                      ...
                      (o > 46
                        ? ($(this)
                          ...
                          $(this)
                            .find(".tab-undo-drag")
                            .css("opacity", o / 60))
                        : ($(this).find(".tab-del-drag").css("opacity", 0),
                          $(this).find(".tab-undo-drag").css("opacity", 0)));
              } else {
                $(this).outerWidth() < 60
                  ? t.releaseDragTab(this)
                  : $(this).addClass("page-findex-out");
              }
            }
          ),
        ...
        $(".page-findex").on("click", ".tab-del-drag", function (e) {
          const i = $(this)
            .closest(".page-findex-item")
            .attr("data-findex-ubix");
    ...
    slideDirection: function (e) {
      return 1 == heyzine.design.data.rtl
        ? "left" == e
          ? "right"
          : "left"
        : e;
    ...
    getTabData: function () {
      ...
      if (
        (this.bookmarkList.length > 0 &&
          (2 == heyzine.design.data.show_outline ||
            3 == heyzine.design.data.show_outline) &&
          (e = e.concat(
            this.config.bookmark.list.filter((e) => null != e.page)
          )),
        ...
        for (let i = 0; i < t.length; i++)
          (t[i].userBookmarkIx = i), e.push(t[i]);
      }
      e.sort((e, t) =>
        null === e.page || null === t.page ? 1 : e.page - t.page
      );
    ...
    turning: function (e) {
      if (this.isEnabled() && null != e) {
        if ("SWIPER" == heyzine.config.viewer) {
          ...
          1 == t.length
            ? $(".page-findex").appendTo(t)
            : $(".page-findex").appendTo(".swiper.container");
        }
        if (this.isOneSide())
          heyzine.getCurrentPage() > e &&
            ($(".magazine-viewport.page-single").addClass("page-controls-turn"),
          ...
          setTimeout(() => {
            ...
            (e == this.lastLeft && t == this.lastRight) ||
              (this.showTabsSide(), (this.lastLeft = e), (this.lastRight = t));
          ...
          const e =
            1 == heyzine.getCurrentPage() ||
            heyzine.getCurrentPage() == heyzine.config.num_pages
              ? this.sideEffectDelay
              : 0;
    ...
    turned: function (e) {
      if (
        this.isEnabled() &&
        (this.isOneSide() &&
          ($(".magazine-viewport.page-single").removeClass(
            "page-controls-turn"
          ),
          $(".page-findex-right").show(
            "slide",
        ...
        const t = $('.swiper-slide[page="' + e + '"]');
        1 == t.length &&
          $(".page-findex").closest(".swiper-slide").attr("page") != e &&
          $(".page-findex").appendTo(t);
      }
    },
    peelStart: function (e) {
      this.isEnabled() &&
        (1 == e.next
          ...
          : e.next == heyzine.config.num_pages &&
            $(".page-findex-right").hide(
              "slide",
              { direction: this.slideDirection("left") },
              this.sideEffectTime
    ...
    createTabDom: function (e, t) {
      ...
      return (
        "{{add-bookmark-left}}" == e.title
          ? ((i = $(
              '<div class="page-findex-item page-bookmark-add page-bookmark-add-left"></div>'
            )),
            i.html(
          ...
          ? ((i = $(
              '<div class="page-findex-item page-bookmark-add page-bookmark-add-right"></div>'
            )),
            i.html(
              '<svg width="16px" height="30px" stroke-width="2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#000000"><path d="M5 21V5a2 2 0 012-2h10a2 2 0 012 2v16l-5.918-3.805a2 2 0 00-2.164 0L5 21z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>'
            ))
          : ((i = $(
              '<div class="page-findex-item" data-findex-id="' +
                e.id +
                '"></div>'
            )),
            i.text(e.title),
            i.attr("data-findex-page", e.page),
            null != e.userBookmarkIx &&
              i.attr("data-findex-ubix", e.userBookmarkIx)),
        e.background
          ? i.css(
              "background-color",
              e.background.indexOf("#") < 0 && e.background.indexOf("rgb") < 0
                ? "rgb(" + e.background + ")"
                : e.background
            )
        ...
        e.color
          ? i.css(
              "color",
              e.color.indexOf("#") < 0 && e.color.indexOf("rgb") < 0
                ? "rgb(" + e.color + ")"
                : e.color
            )
          : i.css("color", "black"),
        e.style &&
          (e.style.indexOf("bold") > -1 && i.css("font-weight", "bold"),
    ...
    createTabsSides: function () {
      ...
      for (let t = 0; t < this.leftSide.length; t++) {
        ...
        0 == t && this.isBookmarksEnabled()
          ? ((i += a.outerHeight()), n.push(a), (o = !0))
          : (0 != t || (0 == t && !this.isBookmarksEnabled())) &&
            ((i += a.outerHeight()), n.push(a));
      }
      t.html(""), t.show();
      for (let e = 0; e < this.rightSide.length; e++) {
        const s = this.rightSide[e],
          a = this.createTabDom(s, t);
        ((0 == e && this.isBookmarksEnabled() && !o) ||
          0 != e ||
          (0 == e && !this.isBookmarksEnabled())) &&
          ((i += a.outerHeight()), n.push(a));
      }
      ...
      if (a >= 0) {
        ...
        for (let i = 0; i < n.length; i++)
          n[i].css("top", t + "px"), (t += n[i].outerHeight() + e);
      } else {
        let e = s / i,
        ...
        for (let i = 0; i < n.length; i++)
          i > 0 &&
            (o +=
              ...
              n[i].outerHeight() * e -
              t),
            n[i].css({ top: o + "px", "z-index": n.length - i });
      }
    ...
    distributeSides: function (e) {
      ...
      (this.rightSide = []),
        (this.leftSide = []),
        this.isBookmarksEnabled() &&
          (this.rightSide.push({ title: "{{add-bookmark-right}}" }),
          this.leftSide.push({ title: "{{add-bookmark-left}}" }));
      for (let e = 0; e < t.length; e++) {
        const n = t[e];
        2 == i.length
          ? n.page >= i[1]
            ? this.rightSide.push(n)
            : this.leftSide.push(n)
          : this.isOneSide() ||
            (n.page >= i[0] && i[0] != heyzine.config.num_pages)
          ? this.rightSide.push(n)
          : this.leftSide.push(n);
      }
      this.rightSide.sort((e, t) =>
        null === e.page || null === t.page ? 1 : e.page - t.page
      ),
        this.leftSide.sort((e, t) =>
          null === e.page || null === t.page ? 1 : e.page - t.page
        );
    },
    show: function () {
      this.isEnabled() &&
        null != this.getTabData() &&
        (this.distributeSides(), this.createTabsSides());
    },
  }),
  "undefined" == typeof hzflip && (hzflip = {}),
  null == hzflip.controls && (hzflip.controls = {}),
  (hzflip.controls.navpanel = {
      ...
      (this.config = e),
        (this.bookmarkList =
          ...
          this.config.bookmark.list.length > 0
            ? this.config.bookmark.list
            : []),
        $("#btnNavPanelBookmarkAdd .btn-nav-panel-text").text(
          heyzine.lang.translate.fromKey("bookmark_add")
        ),
        $("#btnNavPanel")
          .off("click")
          .on(
            "click",
            () => (
              this.isEditMode || (this.opened ? this.hide() : this.show()), !1
            )
          ),
        ...
        $("#pnlNav").on(
          "wheel mousemove touchstart touchend touchmove dblclick",
          (e) => {
            e.stopPropagation();
          }
        ),
          ...
          .on("scroll", () => {
            null != this.tmrThumbPreload && clearTimeout(this.tmrThumbPreload),
              (this.tmrThumbPreload = setTimeout(() => {
                ...
                for (let t = 0; t < e.length; t++) {
                  const i = e[t];
                  "false" == $(i).attr("data-thumb-loaded") &&
                    this.isElementVisible(
                      i,
                      $(".panel-nav-thumbnails-body").get(0)
                    ) &&
                    this.loadThumbnail($(i).attr("data-nav-page"), $(i));
                }
              }, 300));
          });
    },
        ...
        t.attr("data-thumb-loaded", "true"),
          heyzine
            ...
            .then(() => {
              t
                .find("img")
                .attr("alt", heyzine.lang.translate.fromKey("page") + " " + e),
                t
                  .find("img")
                  .attr(
                    "title",
                    heyzine.lang.translate.fromKey("page") + " " + e
                  ),
                2 == heyzine.design.data.show_thumbpanel &&
                  t.append('<div class="panel-nav-page-num">' + e + "</div>"),
                i();
            })
            .catch(() => {
              n();
    ...
    setDisposition: function () {
      ...
      let t = 0;
      1 == e.show_thumbpanel || 2 == e.show_thumbpanel
        ? ($("#btnNavPanelThumbnails").show(), (this.thumbEnabled = !0), t++)
        : ($("#btnNavPanelThumbnails").hide(), (this.thumbEnabled = !1)),
        this.bookmarkList.length > 0 &&
        (1 == e.show_outline || 3 == e.show_outline)
          ? ($("#btnNavPanelOutline").show(), (this.outlineEnabled = !0), t++)
          : ($("#btnNavPanelOutline").hide(), (this.outlineEnabled = !1)),
        1 == e.show_bookmarks || 3 == e.show_bookmarks
          ? ($("#btnNavPanelBookmark").show(), (this.bookmarkEnabled = !0), t++)
          : ($("#btnNavPanelBookmark").hide(), (this.bookmarkEnabled = !1));
      let i = 0;
      $(".panel-nav-thumbnails").is(":visible")
        ? (i = 1)
        : $(".panel-nav-outline").is(":visible")
        ? (i = 2)
        : $(".panel-nav-bookmark").is(":visible") && (i = 3),
        ...
        this.thumbEnabled || this.outlineEnabled || this.bookmarkEnabled
          ? !this.thumbEnabled || (1 != i && 0 != i)
            ? !this.outlineEnabled || (2 != i && 0 != i)
              ? !this.bookmarkEnabled ||
                (3 != i && 0 != i) ||
                $("#pnlNav .panel-nav-bookmark").show()
              : $("#pnlNav .panel-nav-outline").show()
            : $("#pnlNav .panel-nav-thumbnails").show()
          : this.hide(),
        t <= 1
          ? $("#pnlNav").addClass("no-sections")
          : $("#pnlNav").removeClass("no-sections");
    },
    loadForEditor: function (e) {
    ...
    open: function () {
      this.isOpened() ||
        (heyzine.controls.showPanelLateral("#pnlNav"),
        $("#pnlNav").show(),
        (this.opened = !0));
    },
    show: function (e, t) {
      this.thumbEnabled && this.loadThumbnails(e),
        ...
        this.bookmarkEnabled &&
          (this.loadBookmarks(e), this.hideBookmarkEdit()),
        (null != t && !0 !== t) ||
          (heyzine.controls.showPanelLateral("#pnlNav"),
          $("#pnlNav").show(),
          (this.opened = !0));
    ...
    loadThumbnails: function (e) {
      ...
      for (let e = 1; e <= this.config.num_pages; e++) {
        const i = $(
          '<div class="panel-nav-page" data-nav-page="' + e + '"></div>'
        );
        $("#pnlNav .panel-nav-thumbnails-body").append(i),
          heyzine.isLandscape() ||
          1 == e ||
          (e == this.config.num_pages && this.config.num_pages % 2 == 0)
            ? i.addClass("panel-nav-page-full")
            : e % 2 != 0 && i.addClass("panel-nav-page-odd");
        for (let n = 0; n < t.length; n++)
          e == t[n] && i.addClass("panel-nav-page-current");
        i.attr("data-thumb-loaded", "false"),
          (this.config.num_pages <= heyzine.tocMaxPages ||
            e <= this.thumbPreloadNum) &&
            this.loadThumbnail(e, i);
      }
    },
    loadOutline: function (e) {
      if ((null != e && (this.config = e), this.bookmarkList.length <= 0))
        return;
    ...
    loadBookmarks: function (e) {
      ...
      for (let e = 0; e < t.length; e++) {
        const i = $(
          '<div class="panel-nav-bm"><span class="lblTextBookmark"></span></div>'
        );
        i.attr("data-nav-page", t[e].page),
          i.attr("data-nav-ix", e),
          i.append(
            '<input type="text" maxlength="55" class="panel-nav-bm-text panel-nav-bm-btn" />'
          ),
          i.append(
  ...
  (hzflip.layers = {
    ...
    load: function (e) {
      (this.layers = e),
        ...
        (null != heyzine.design.data.sound_flip &&
          (1 == $.trim(heyzine.design.data.sound_flip) ||
            !0 === heyzine.design.data.sound_flip)) ||
        this.existSoundLayers()
          ? $("#btnSoundOff").show()
          : $("#btnSoundOff").hide();
    },
    existSoundLayers: function () {
      return (
        ...
        this.layers.findIndex(
          (e) =>
            ("background" == e.type && "audio" == e.media.type) ||
            "video" == e.type ||
            "audio" == e.type
        ) > -1
      );
    ...
    repositionEditLayers: function (e) {
      if (this.isEditMode)
        for (let t = 0; t < this.layers.length; t++) {
          ...
          if (
            (i.visible && !this.singlePage) ||
            (i.page == e && this.singlePage)
          ) {
            ...
            (this.layers[t].css.width =
              ($(n).width() / i.wrapper.width) * i.css.width),
              (this.layers[t].css.height =
                ($(n).height() / i.wrapper.height) * i.css.height),
              (this.layers[t].css.left =
                $(n).offset().left -
                o.offset().left +
                (i.css.left - i.wrapper.left) *
                  ($(n).width() / i.wrapper.width)),
              (this.layers[t].css.top =
                $(n).offset().top -
                o.offset().top +
                (i.css.top - i.wrapper.top) *
                  ($(n).height() / i.wrapper.height)),
      ...
      for (let t = 0; t < this.layers.length; t++)
        if (
          ...
          (e == this.config.num_pages && this.config.num_pages % 2 == 0)
            ...
            : (e != this.config.num_pages && e != this.config.num_pages - 1) ||
              this.config.num_pages % 2 == 0
            ? ((e % 2 == 0 &&
                (e == this.layers[t].page ||
                  (e + 1 == this.layers[t].page &&
                    e + 1 != this.config.num_pages))) ||
                (e % 2 != 0 &&
                  (e == this.layers[t].page ||
                    (e - 1 == this.layers[t].page && e - 1 != 1)))) &&
              (this.layers[t].visible = !0)
            : (e != this.layers[t].page && e + 1 != this.layers[t].page) ||
              (this.layers[t].visible = !0),
          this.layersDom[t])
        ) {
          this.layers[t].visible &&
          this.layers[t].action &&
          1 == this.layers[t].action.highlight
            ? this.layersDom[t].addClass("layer-action-highlight")
            : this.layersDom[t].removeClass("layer-action-highlight");
          const i = this.layers[t];
          if (i && "video" == i.type) {
            if ("youtube" == i.media.type) {
              ...
              if (n.length > 0) {
                ...
                (i.visible && !this.singlePage) ||
                (i.page == e && this.singlePage)
                  ? "1" == i.media.options.autoplay &&
                    n.attr("src", t.replace("&autoplay=0", "&autoplay=1"))
              ...
              null != n &&
                ...
                (i.page == e && this.singlePage)
                  ...
                  : !0 === i.media.played && "1" == i.media.options.once
                  ? ((n.currentTime = n.duration), n.pause())
                  : ("1" == i.media.options.restart && (n.currentTime = 0),
                    n.pause()));
            }
            ...
            null != n &&
              ((i.visible && !this.singlePage) ||
              (i.page == e && this.singlePage)
                ? "1" == i.media.options.autoplay && (n.pause(), n.play())
                : 1 != i.media.options.keep && n.pause());
          } else
            i &&
              "picture" == i.type &&
              this.layersDom[t].hasClass("layer-action-gif") &&
              this.layersDom[t]
                .find("img")
                .attr("src", this.layersDom[t].find("img").attr("src"));
        }
    },
    ...
    startTurnAudio: function (e, t, i) {
      let n = i;
      this.layersComp[n] ||
        ((this.layersComp[n] = new Audio(encodeURI(t.media.url))),
        (this.layersComp[n].compType = "backAudio"),
        null != t.media.options &&
          t.media.options.volume &&
          (this.layersComp[n].volume = t.media.options.volume / 100),
        ...
        this.layersComp[n].addEventListener("ended", (e) => {
          if (
            null != this.lastPage &&
            this.lastPage >= this.layers[n].page &&
            this.lastPage <= this.layers[n].page_end
          ) {
            null != t.media.options &&
              t.media.options.loop &&
              ((this.layersComp[n].currentTime = 0), this.layersComp[n].play());
            for (let e = 0; e < this.layers.length; e++)
              if (
                this.layers[e] &&
                "background" == this.layers[e].type &&
                "audio" == this.layers[e].media.type
              ) {
      ...
      let o = e >= t.page && e <= t.page_end,
        ...
        a =
          null != this.lastPage &&
          this.lastPage >= t.page &&
          this.lastPage <= t.page_end;
      if (
        (null == this.lastPage ||
          this.lastPage < t.page ||
          this.lastPage > t.page_end) &&
        ...
        return (
          !1 === this.soundEnabled &&
            (this.layersComp[n].muted = !this.soundEnabled),
      ...
      return a && o
        ? (t.media.played || this.layersComp[n].play(), !1)
        : (!s ||
            (null != t.media.options &&
              null != t.media.options.keep &&
              !1 !== t.media.options.keep) ||
            this.layersComp[n].pause(),
          !1);
    },
    resetLayersComp: function () {
      for (let e = 0; e < this.layersComp.length; e++)
        this.layersComp[e] &&
          ("audio" == this.layersComp[e].compType
            ? this.layersComp[e].unload()
            : "backAudio" == this.layersComp[e].compType &&
              this.layersComp[e].pause());
    ...
    loadPageLayers: function (e, t, i) {
      if (
        ($(t).find(".layer-action-render").remove(),
      ...
      for (let i = 0; i < this.layers.length; i++)
        if (e == this.layers[i].page) {
          const e = $(
            '<div class="layer-action-render" id="layer' +
              this.layers[i].id +
              '" style="position: absolute;" data-disable-events="start"></div>'
          );
          if (
            (e
              .appendTo(t)
              .css({
                left:
                  ((this.layers[i].css.left - this.layers[i].wrapper.left + 1) /
                    this.layers[i].wrapper.width) *
                    100 +
                  "%",
                top:
                  ((this.layers[i].css.top - this.layers[i].wrapper.top + 1) /
                    this.layers[i].wrapper.height) *
                    100 +
                  "%",
                width:
                  (this.layers[i].css.width / this.layers[i].wrapper.width) *
                    100 +
                  "%",
                height:
                  (this.layers[i].css.height / this.layers[i].wrapper.height) *
                    100 +
                  "%",
              }),
            (this.layersDom[i] = e),
            ...
            if (
              (e.addClass("layer-action-vid"),
              t.options &&
                "4" == t.options.controls &&
                e.addClass("layer-controls-disabled"),
              "youtube" == t.type)
            )
              $("<iframe>", {
                class: "layer-vid",
                ...
                src: encodeURI(t.url).replace("&autoplay=1", "&autoplay=0"),
              }).appendTo(e);
            else {
              let n =
                  t.options &&
                  "1" == t.options.autoplay &&
                  1 == this.layers[i].page,
                o =
                  t.options &&
                  "1" == t.options.once &&
                  1 == this.layers[i].page;
            ...
            if (null != t.url && "null" != t.url) {
              const i = $("<iframe>", {
                class: "layer-web",
                allow:
                  "autoplay *;camera *;microphone *;geolocation *;gyroscope *;fullscreen *;display-capture *;",
                allowusermedia: "allowusermedia",
                allowfullscreen: "allowfullscreen",
                src: encodeURI(t.url),
              });
              1 == t.options.noscroll && i.attr("scrolling", "no"),
                i.appendTo(e);
            }
          ...
          "zoom" == this.layers[i].action.type &&
            e.addClass("layer-zoom").addClass("layer-zoom-in"),
            this.loadLayerActions(
              e,
              this.layers[i],
              "#layer" + this.layers[i].id
            ),
          ...
          heyzine.layers.popup.closeAll(),
            "page" == t.action.type
              ? "" != $.trim(t.action.target) &&
                (heyzine.goToPage(parseInt(t.action.target)),
                heyzine.stats.trackLayer("link-int", t))
              : "link" == t.action.type
              ? "" != $.trim(t.action.target) &&
                (t.action.extra && "1" == t.action.extra.new_tab
                  ? (heyzine.navigate(t.action.target, "newtab"),
              ...
              : "zoom" == t.action.type
              ? "" != $.trim(t.action.target) &&
                (heyzine.setZoom("zoomLayer", t.id, {
    ...
    soundToggle: function (e) {
      if (((this.soundEnabled = e), null != this.layers)) {
              ...
              if ("youtube" == t.media.type) {
                if (null == i || null == i.options || "1" != i.options.mute) {
                  const t = $(this.layersDom[e]).find("iframe"),
                    i = t.attr("src");
                  this.soundEnabled
                    ? t.attr("src", i.replace("&mute=1", "&mute=0"))
                    : t.attr("src", i.replace("&mute=0", "&mute=1"));
                }
              } else {
        ...
        for (let e = 0; e < this.layersComp.length; e++)
          this.layersComp[e] &&
            (null == this.soundEnabled
              ? (this.layersComp[e].muted = !1)
              : (this.layersComp[e].muted = !this.soundEnabled));
      }
    },
    soundBackgroundPause(e) {
      for (let t = 0; t < this.layersComp.length; t++)
        if (this.layersComp[t]) {
          let i = !1;
          if ("audio" == this.layersComp[t].compType)
            i = !this.layersComp[t].isPlaying();
          else {
            if ("backAudio" != this.layersComp[t].compType) continue;
            i = this.layersComp[t].paused;
          }
          e
            ? i
              ? (this.layersComp[t].wasPlaying = !1)
              : ((this.layersComp[t].wasPlaying = !0),
                this.layersComp[t].pause())
            : this.layersComp[t].wasPlaying &&
              (this.layersComp[t].play(), (this.layersComp[t].wasPlaying = !1));
        }
    },
    ...
    createPicture: function (e, t, i) {
      ...
      let o = encodeURI(t.media.url);
      !this.layersGif[i] ||
        (".svg" != n && ".gif" != n) ||
        ((o = this.layersGif[i]), e.addClass("layer-action-gif")),
        e.addClass("layer-action-pic"),
        "" == $.trim(t.action.target) && e.css("cursor", "auto");
      const s = $("<img>", { class: "layer-pic", src: o });
      s.appendTo(e), s.attr("draggable", "false");
    },
    createVideoPlayer: function (e, t, i) {
      ...
      t.options && "1" == t.options.controls
        ? n.attr("controls", "")
        : n.on("click", function () {
            this.paused ? this.play() : this.pause();
          }),
        i.muted && n.attr("muted", ""),
        i.autoplay && n.attr("autoplay", ""),
        t.options && t.options.loop && n.attr("loop", ""),
        n.on("contextmenu", function () {
          return !1;
        });
      const o = $("<source>", {
        src: encodeURI(t.url) + "#t=0.1",
        type: "video/mp4",
      });
      if (
        (n.append(o),
        $(e).append(n),
        i.muted && null != n && null != n.get(0) && (n.get(0).muted = !0),
        "1" == i.autoplay && "1" == i.once && (t.played = !0),
        t.options && ("2" == t.options.controls || "3" == t.options.controls))
      ) {
        let i =
          '<div class="layer-vid-controls-min" data-options="' +
          t.options.controls +
          '">';
        ...
        $(n).addClass("vid-no-controls"),
          $(document).off(
            "mouseenter",
            "#" + $(e).attr("id") + " .layer-vid-controls-min"
          ),
          $(document).on(
            "mouseenter",
            "#" + $(e).attr("id") + " .layer-vid-controls-min",
          ...
          $(document).off(
            "click",
            "#" + $(e).attr("id") + " .layer-vid-fullscreen"
          ),
          $(document).on(
            "click",
            "#" + $(e).attr("id") + " .layer-vid-fullscreen",
  ...
  (hzflip.player = {
    createPlayer: function (e, t) {
      ...
      f.prototype = {
        ...
        step: function () {
          ...
          let i = t.seek() || 0;
          i > 0 &&
            ($(s).html(e.formatTime(Math.round(i))),
            $(g).css(
              "width",
              Math.round((i / t.duration()) * $(u).width() || 0) + "px"
            )),
        ...
        waveAnim: function (e) {
          "wave" != this.song.style
            ? "ocean" != this.song.style ||
              ("start" == e
                ? $(n).removeClass("paused")
                : "stop" == e && $(n).addClass("paused"))
            : "load" == e
            ...
            : "start" == e
            ? (null == this.siriWave && this.waveAnim("load"),
              this.siriWave.start())
      ...
      return (
        ...
        $(document).on(
          ...
          function (e) {
            if (
              (0 === e.originalEvent.buttons && (m.seekerDown = !1),
              m.seekerDown)
            ) {
              let t =
                null != e.clientX
              ...
              let i =
                Math.round(
                  ((t - $(u).offset().left) /
                    ($(u).width() * heyzine.getZoomScale())) *
                    1e4
                ) / 1e4;
              m.seekView(i),
                (null == m.lastSeekPos || Math.abs(m.lastSeekPos - i) > 0.01) &&
                  (m.seek(i), (m.lastSeekPos = i));
            }
          }
        ),
        $(document).off(
    ...
    getTemplateDefault: function (e, t) {
      let i = t.style;
      return "none" == i
        ? this.getThemeNone(e, t)
        : "btn" == i
        ? this.getThemeBtn(e, t)
        : "ocean" == i || "wave" == i
        ? this.getThemeVisualizer(e, t)
        : "min" == i
        ? this.getThemeBar(e, t)
        : void 0;
    },
    getThemeNone: function (e, t) {
      return (
        $(e).addClass("layer-player-none"),
    ...
    getThemeVisualizer: function (e, t) {
      ...
      return (
        ...
        "ocean" == i
          ? (n +=
              '<div class="theme-player theme-ocean"><div class="theme-back-cont"><div class="wave"></div><div class="wave"></div></div></div>')
          : "wave" == i && (n += '<div class="theme-siri"></div>'),
  ...
  (hzflip.layers.popup = {
    ...
    createTooltip: function (e) {
      ...
      i.appendTo($("#canvas")),
        (s =
          Math.round(
            (45 * $(".page-wrapper[page=" + e.page + "]").width()) / 100
          ) + "px"),
      ...
      return (
        t ||
          (a =
            Math.round($(o).offset().left - $("#canvas").offset().left) + "px"),
        i.css({
          width: s,
          height: "auto",
          left: a,
    ...
    repositionTooltip: function (e) {
      ...
      t ||
        (s =
          Math.round($(n).offset().left - $("#canvas").offset().left) + "px"),
        i.css({
          width: o,
          height: "auto",
          left: s,
      ...
      return (
        ...
        t.on("click", (e) => {
          ...
          i.is(e.target) ||
            ...
            this.pausedBackgroundAudio &&
              ((this.pausedBackgroundAudio = !1),
              heyzine.layers.soundBackgroundPause(!1)),
            e.preventDefault(),
            e.stopPropagation();
        }),
        ...
        this.createContent(e)
          .then((n) => {
            this.createCloseButton(e, n, i),
              ...
              ("video" != e.action.subtype && "youtube" != e.action.subtype) ||
                ("1" != e.action.extra.mute &&
                  (heyzine.layers.soundBackgroundPause(!0),
                  (this.pausedBackgroundAudio = !0)));
          })
          .catch((e) => {
            console.log(e);
          }),
      ...
      return new Promise((t, i) => {
        ...
        if ("picture" == e.action.subtype)
          (n = $(
            '<img src="' +
              e.action.target +
              '" class="layer-popup-picture layer-popup-el" />'
          )),
            $(n).on("load", () => {
              t(n);
            });
          ...
          (n = $(
            '<iframe class="layer-popup-web layer-popup-el" allowfullscreen ' +
              i +
              ' src="' +
              e.action.target +
              '"></iframe>'
          ...
          (n = $('<div class="layer-popup-video layer-popup-el">')),
            e.action.extra &&
              "4" == e.action.extra.controls &&
              n.addClass("layer-controls-disabled");
          const i = heyzine.layers.createVideoPlayer(
            n,
            { url: e.action.target, options: e.action.extra },
            {
          ...
          "youtube" == e.action.subtype
            ? ((n = $('<div class="layer-popup-video layer-popup-el">')),
              e.action.extra &&
                ...
                n.addClass("layer-controls-disabled"),
              n.append(
                '<iframe class="layer-vid" allow="autoplay" allowfullscreen src="' +
                  e.action.target +
                  '"></iframe>'
              ),
              t(n))
    ...
    setPositionFloat: function (e, t) {
      e.css({
        ...
        e.offset().top < $("#magazineViewport").offset().top &&
          (e.css({ "margin-top": t.height() + 15 }),
          e.addClass("layer-popup-float-bottom")),
        0 != $(e).find(".layer-popup-video").length &&
          0 != $(e).find("video").length &&
          $(e).find(".layer-vid").css("float", "left");
    },
    setPositionModal: function (e) {
      ...
      if (s.width > o.boundWidth || s.height > o.boundHeight) {
        ...
        o.boundWidth / a > o.boundHeight && o.boundHeight * a <= o.boundWidth
          ? ((s.width = Math.round(o.boundHeight * a)),
            (s.height = o.boundHeight))
          : ((s.width = o.boundWidth),
  ...
  (hzpdf = {
    ...
    load: (e, t) => (
      ...
      new Promise((t, i) => {
        ...
        if (heyzine.config.size > 15e6) {
          ...
          t < 1e7 && heyzine.config.num_pages > 100
            ? (t = 1e7)
            : t < 1048576 && (t = 1048576),
            (n = {
              url: e,
        ...
        "undefined" != typeof hzp &&
          (o.onProgress = function (e) {
            0 == hzp.val &&
              ...
              e.total > 0 &&
              hzp.check(
                heyzine.config.width,
                heyzine.config.height,
                heyzine.config.num_pages,
                e.total,
                heyzine.config.id
              );
    ...
    processRender: function (e, t, i, n) {
      console.log(Math.round(new Date().getTime() / 1e3) + " startrender " + e),
        heyzine.progressBar("progress", { inc: 10, abs: 40 });
      var o = t.render(i);
        ...
        o.promise
          .then(() => {
            (this.renderQueue = this.renderQueue.filter((e) => e.resolve != n)),
              console.log(
                Math.round(new Date().getTime() / 1e3) + " endrender " + e
              ),
              ...
              this.renderQueue.length > 0 &&
                (this.sortRenderQueue(),
                this.processRender(
                  this.renderQueue[0].numPage,
                  this.renderQueue[0].page,
                  this.renderQueue[0].renderContext,
                  this.renderQueue[0].resolve
                ));
          })
          .catch(() => {
    ...
    sortRenderQueue: function () {
      this.renderQueue.sort((e, t) => {
        ...
        return (e.numPage < i && t.numPage < i) ||
          (e.numPage > i && t.numPage > i)
          ? e.numPage - t.numPage
          : e.numPage >= i && t.numPage < i
          ? -1
          : e.numPage < i && t.numPage >= i
          ...
          : (this.loadingPages.push({ page: e, size: i }),
            this.loadPageUrl(e, n, i).then((n) => {
              ...
              if (scaler.isIos() && "MAGAZINE" == heyzine.viewer.viewerName) {
                ...
                let i = "";
                "album" != heyzine.design.data.type &&
                  (i += "translate3d(0,0,0) "),
                  heyzine.controls.zoom.getScale() > 1
                    ? (e.css(
                        "width",
                        "calc(100% * " + heyzine.controls.zoom.getScale() + ")"
                      ),
                      e.css(
                        "height",
                        "calc(100% * " + heyzine.controls.zoom.getScale() + ")"
                      ...
                      (i +=
                        "scale(" + 1 / heyzine.controls.zoom.getScale() + ")"),
                      e.css("transform", i),
              ...
              (this.loadingPages = this.loadingPages.filter(
                (t) => !(t.page == e && t.size == i)
              )),
                o(t);
            }));
      ...
      return new Promise((o, s) => {
        console.log(Math.round(new Date().getTime() / 1e3) + " loadpage " + e),
          heyzine.pdf
            ...
            .then(function (s) {
              console.log(
                Math.round(new Date().getTime() / 1e3) + " loadpage end " + e
              ),
                heyzine.progressBar("progress", { inc: 20, abs: 30 });
              let a = n.loadViewport(s, e, i);
              var l = t.getContext("2d", { willReadFrequently: !0 });
              a.width - Math.trunc(a.width) > 0.9999 ||
              a.height - Math.trunc(a.height) > 0.9999
                ? ((t.height = Math.round(a.height)),
                  (t.width = Math.round(a.width)))
                : ((t.height = Math.trunc(a.height)),
                  (t.width = Math.trunc(a.width))),
                n.fixedAspectRatio ||
                  ((heyzine.renderAspectRatio = a.height / a.width),
    ...
    loadImage: (e, t) =>
      new Promise((t, i) => {
        ...
        (o.onload = function () {
          ...
          (o.style =
            "width: " + i + "px; object-position:-" + i * (e - 1) + "px"),
    ...
    getDesiredCanvasSize: (e) => {
      ...
      0 == t &&
        (t = $(document).width() / 2 > 300 ? $(document).width() / 2 : 300);
      let i = t;
      return (
        i <= 800 && (i = 3 * t),
        void 0 !== e &&
          (i =
            "large" == e
              ? 3 * t * window.devicePixelRatio
              : "xlarge" == e
              ? 6 * t * window.devicePixelRatio
              : "normal" == e
              ? t * window.devicePixelRatio
              : "small" == e
              ? (t / 1.5) * window.devicePixelRatio
              : e),
        (i = Math.trunc(i)),
        i
      );
  ...
  (hzimg = {
    ...
    loadPageView: (e, t, i) => {
      ...
      for (let e = 0; e < heyzine.pictures.length; e++)
        e < 2
          ? n.append(
              '<div class="hz-grid-item" style="width: 160px;"><img src="' +
                heyzine.pictures[e].url +
                '" /></div>'
            )
          : n.append(
              '<div class="hz-grid-item" style="width: 80px;"><img src="' +
                heyzine.pictures[e].url +
                '" /></div>'
            );
      n.appendTo(t);
      ...
      return new Promise((i, n) => {
        ...
        (o.src = this.pictureUrl),
          ...
          $(t)
            ...
            .css("box-shadow", "0 0 20px 2px lightgray"),
  ...
  (hzflip.helpers.loading = {
    show: (e, t, i) => {
      ...
      if (null == e || null == t)
        return (
          $(".page-wrapper .page").append('<div class="gradient"></div>' + n),
      ...
      if ("crisp" == e && null != t) {
        ...
        return (
          e.append(heyzine.thumbnail),
          e.append(n),
          void t
            .find(".loader-preview")
            .addClass("loader-preview-effect-done")
    ...
    hide: function (e) {
      return new Promise((t, i) => {
        null == e
          ? $("#magazineViewport").find(".loader").remove()
  ...
  (hzflip.viewers.magazine = {
      ...
      (n.config = e),
        ...
        null != t &&
          ("book" == t.type
            ...
            : "notebook" == t.type &&
              $(".magazine-viewport")
                .addClass("magazine-book")
                .addClass("round-pages"),
          "1" == t.rtl
            ? $(".magazine").attr("dir", "rtl")
            : $(".magazine").removeAttr("dir"),
          1 == t.show_double
            ? ($(".magazine-viewport").removeClass("page-single"),
              $(".magazine-viewport").addClass("page-double"))
            : 2 == n.design.show_double
            ? ($(".magazine-viewport").removeClass("page-double"),
              $(".magazine-viewport").addClass("page-single"))
            : ($(".magazine-viewport").removeClass("page-single"),
              $(".magazine-viewport").removeClass("page-double"))),
          ...
          ? (i.turn({
              ...
              when: {
                start: function (e, t, i) {
                  if (
                    "undefined" != typeof heyzinea &&
                    null != heyzinea.api &&
                    null != heyzinea.api.flipbook &&
                    null != heyzinea.api.flipbook.options &&
                    null != heyzinea.api.flipbook.options.disableCorners
                  ) {
                    const t = heyzinea.api.flipbook.options.disableCorners;
                    for (let n = 0; n < t.length; n++)
                      if (i == t[n])
                        return (
                          (this.startDisabled = !0), void e.preventDefault()
                        );
                  }
                  if (n.isEditMode || n.isZoomedIn)
                    return (this.startDisabled = !0), void e.preventDefault();
                ...
                turned: function (t, i, o) {
                  ...
                  for (let t = 4; t < 8; t++)
                    i + t <= e.num_pages &&
                      !n.isPageLoaded(i + t) &&
                      (n.addPage(i + t, $(this)), n.loadedPages.push(i + t));
                },
                missing: function (e, t) {
                  for (var i = 0; i < t.length; i++)
                    n.addPage(t[i], $(this)), n.loadedPages.push(t[i]);
                },
              },
            }),
    ...
    isPageLoaded: function (e) {
      for (var t = 0; t < this.loadedPages.length; t++)
        if (e == this.loadedPages[t]) return !0;
      return !1;
    },
    addPage: (e, t) => {
      ...
      s.addClass("page-cont"),
        e == n.num_pages
          ? s.addClass("page-last")
          : e == n.num_pages - 1 && s.addClass("page-second-last"),
        null != n &&
          null != o &&
          null != o.type &&
          ("book" == o.type || "notebook" == o.type
            ? (1 == e ||
                2 == e ||
                e == n.num_pages ||
                (n.num_pages % 2 == 0 && e == n.num_pages - 1)) &&
              s.addClass("hard")
            : "album" == o.type && s.addClass("hard")),
        t.turn("addPage", s, e) &&
          (1 == e && null != n.thumbnail && "" != $.trim(n.thumbnail)
            ? heyzine.helpers.loading.show("crisp", s, e)
            : heyzine.helpers.loading.show("blur", s, e),
          heyzine
    ...
    getVisiblePages: function (e) {
      ...
      var n = $("#canvas").width(),
        o = $("#canvas").height();
      return (n < 750 && n <= o && 0 == t.design.show_double) ||
        2 == t.design.show_double
        ? [i]
        : 1 == i
        ? [1]
        : this.isLastPage(i)
    ...
    isLastPage: (e) => {
      ...
      return (n < 750 && n <= o && 0 == t.design.show_double) ||
        ...
        : (t.config.num_pages % 2 != 0 &&
            (i == t.config.num_pages || i == t.config.num_pages - 1)) ||
            (t.config.num_pages % 2 == 0 && i == t.config.num_pages);
    },
    adjustPageDepth: function (e) {
        ...
        (null != this.design.show_round && 1 == this.design.show_round
          ? ($(".magazine-viewport .page-depth > img").each(function () {
              $(this).attr(
                ...
                $(this)
                  .attr("src")
                  .replace("pages-depth.svg", "pages-depth-rounded.svg")
              );
            }),
          ...
          : ($(".magazine-viewport .page-depth > img").each(function () {
              $(this).attr(
                ...
                $(this)
                  .attr("src")
                  .replace("pages-depth-rounded.svg", "pages-depth.svg")
              );
            }),
            (t = 4)),
      ...
      e == this.config.num_pages
        ? 1 == this.design.rtl
          ? (c(0), l())
          : (h(0), r())
        : 1 == e && (1 == this.design.rtl ? (h(0), r()) : (c(0), l())),
        o < 1 ||
        e == this.config.num_pages ||
        e == this.config.num_pages - 1 ||
        ("double" == a && e == this.config.num_pages - 2)
          ? 1 == this.design.rtl
            ? c()
            : h()
          : 1 == this.design.rtl
    ...
    resizeViewport: () => {
      ...
      if (
        ...
        $(".magazine-viewport").css({ width: t, height: i }),
        null != n)
      ) {
        var o = !1,
          s = n.width;
        0 == e.design.show_double
          ? t < 750 && t <= i
            ? ((s = n.width / 2),
              (o = !0),
              "double" == $(".magazine").turn("display") &&
                ($(".magazine").turn("display", "single"),
                heyzine.setPageDisplay("single")))
            : ((s = n.width),
              (o = !1),
              "single" == $(".magazine").turn("display") &&
                ($(".magazine").turn("display", "double"),
                heyzine.setPageDisplay("double")))
        ...
        a.width % 2 != 0 && a.width--,
          null != heyzine.renderAspectRatio &&
            (a.height = o
              ? Math.trunc(a.width * heyzine.renderAspectRatio)
              : Math.trunc((a.width / 2) * heyzine.renderAspectRatio)),
          (a.width == $(".magazine").width() &&
            a.height == $(".magazine").height()) ||
            ($(".magazine").turn("size", a.width, a.height),
    ...
    calculateBound: (e) => {
      ...
      if (t.width > e.boundWidth || t.height > e.boundHeight) {
        ...
        e.boundWidth / i > e.boundHeight && e.boundHeight * i <= e.boundWidth
          ? ((t.width = Math.round(e.boundHeight * i)),
            (t.height = e.boundHeight))
          : ((t.width = e.boundWidth),
  ...
  (hzflip.viewers.swiper = {
    ...
    render: (e, t) => {
      $("#pnlControls .slider-toolbar").remove(),
        ...
        $("#canvas").fadeIn(1e3),
        $(".logo-backs2").length > 0 &&
          ($(".logo-backs2").parent().is("a")
            ? $(".logo-backs2").parent().appendTo("#canvas")
            : $(".logo-backs2").appendTo("#canvas"));
      var i = hzflip.viewers.swiper;
      (i.config = e),
        (i.design = t),
        null != t &&
          ("1" == t.rtl
            ? $("#magazineViewport .container").attr("dir", "rtl")
            : $("#magazineViewport .container").removeAttr("dir")),
        (i.slides = []);
      for (let t = 0; t < e.num_pages; t++) i.slides.push(t);
      e.num_pages <= 1 &&
        $("#magazineViewport .container").addClass("swiper-one-page"),
        i.resizeViewport();
          ...
          renderExternal: function (e) {
            ...
            for (let t = 0; t < e.slides.length; t++) {
              ...
              if (n.find('[data-slidei="' + o + '"]').length <= 0 && o >= r) {
                const e = $(
                  '<div class="swiper-slide page-wrapper" data-slidei="' +
                    o +
                    '" page="' +
                    (o + 1) +
                    '"><div class="swiper-zoom-container page-cont p' +
                    (o + 1) +
                    '"></div></div>'
                );
                e.appendTo(n),
                  o + 1 == 1
                    ? heyzine.helpers.loading.show(
                        "crisp",
                        e.find(".swiper-zoom-container"),
                        o + 1
                      )
                    : heyzine.helpers.loading.show(
                        "blur",
                  ...
                  heyzine
                    ...
                    .then(() => {
                      $(".swiper-slide").children().addClass("inactive"),
                        $(
                          '.swiper-slide[data-slidei="' +
                            i.slides[i.swiper.realIndex] +
                            '"]'
                        )
                          .children()
            ...
            "vertical" == o
              ? $(".swiper-slide").css("top", Math.abs(h))
              : $(".swiper-slide").css("left", h);
          },
        },
        on: {
          slideChange: function () {
            ...
            $(".swiper-slide").children().addClass("inactive"),
              ...
              setTimeout(() => {
                $('.swiper-slide[data-slidei="' + e + '"]').addClass(
                  "swiper-slide-active"
                ),
                  heyzine.turned(e + 1),
                  heyzine.helpers.loading.startEffect();
    ...
    goToPage: (e, t) => {
      ...
      "string" != typeof e ||
      "next" != e ||
      ("keyboard" != t && "button-nav" != t)
        ? "string" != typeof e ||
          "previous" != e ||
          ("keyboard" != t && "button-nav" != t)
          ? isNaN(parseInt(e)) ||
            (i.isEditMode
              ? i.swiper.slideTo(parseInt(e) - 1, 0)
              : i.swiper.slideTo(parseInt(e) - 1))
          : i.isEditMode
    ...
    setZoom: function (e, t) {
      null == e
        ? this.enabledEvents ||
          (heyzine.viewer.swiper.attachEvents(), (this.enabledEvents = !0))
        : "string" == typeof e &&
          ("zoomIn" == e
            ? this.enabledEvents &&
              (heyzine.viewer.swiper.detachEvents(), (this.enabledEvents = !1))
            : "zoomOut" == e &&
              (this.enabledEvents ||
                (heyzine.viewer.swiper.attachEvents(),
    ...
    resizeViewport: function () {
      ...
      const t = scaler.getObjectFitSize(
        !0,
        $("#canvas").width(),
        $("#canvas").height(),
        this.config.width,
    ...
    isLastPage: (e) => {
      ...
      return null == e
        ? t.slides[t.swiper.realIndex] + 1 == t.config.num_pages
        : e == t.config.num_pages;
    },
    setEditMode: function (e) {
      (this.isEditMode = e),
        this.isEditMode
          ? (heyzine.viewer.swiper.params.speed = 0)
          : (heyzine.viewer.swiper.params.speed = 300);
    },
    adjustPageDepth: function (e) {},
  }),
  ...
  (hzp = {
    ...
    hash: function (e, t) {
      return crypto.subtle
        .digest(e, new TextEncoder("utf-8").encode(t))
        .then((e) =>
          Array.prototype.map
            .call(new Uint8Array(e), (e) => ("00" + e.toString(16)).slice(-2))
            .join("")
        );
    },
  ...
  (hzflip.stats = {
    ...
    track: function (e, t, i, n) {
      ...
      if (this.sessionTracks[s] && a - this.sessionTracks[s] < 30)
        return null != n && n(), void (null != o && clearTimeout(o));
    ...
    trackLayer: function (e, t, i) {
      let n = null;
      null != t.action.target
        ? (n = t.action.target)
        : null != t.media && null != t.media.url && (n = t.media.url),
  ...
  (heyzineDesign = {
    ...
    load: function (e) {
      ...
      $("#pnlControls").show(),
        t
          ? ($("#pnlControls").hide(),
            $("#pnlControls").addClass("panel-controls-hidden"))
          : ($("#pnlControls").show(),
        ...
        this.setLogo(e),
        this.setTooltips(),
        (document.location.href.indexOf("?ctl=0") > 0 ||
          document.location.href.indexOf("&ctl=0") > 0) &&
          $("#pnlControls").hide(),
    ...
    setTitle: function (e) {
      $(".flipbook-title").hide(),
        ...
        null != e.show_text &&
          ...
          "" != $.trim(e.title) &&
          ($(".flipbook-title h1").html(
            sanitizer.sanitize(e.title.replace(/(?:\r\n|\r|\n)/g, "<br>"))
          ),
          $(".flipbook-title").show()),
        null != e.show_text &&
          1 == e.show_text &&
          ...
          "" != $.trim(e.subtitle) &&
          ($(".flipbook-title h2").html(
            sanitizer.sanitize(e.subtitle.replace(/(?:\r\n|\r|\n)/g, "<br>"))
          ),
          $(".flipbook-title").show()),
        null != e.show_text &&
          1 == e.show_text &&
          ...
          "" != $.trim(e.description) &&
          ($(".flipbook-title p").html(
            sanitizer.sanitize(e.description.replace(/(?:\r\n|\r|\n)/g, "<br>"))
          ),
          $(".flipbook-title").show());
    },
    setBackground: function (e) {
      if (
        ...
        null != e.background_color &&
          "" != $.trim(e.background_color) &&
          $(".logo-backs").parent().css("background-color", e.background_color),
        ...
        null != t.size && $(".logo-backs").css("background-size", t.size),
          null != t.size &&
            $(".logo-backs").css("background-position", t.position),
          null != t.transparency &&
            $(".logo-backs").css("opacity", 1 - t.transparency / 100),
          null != t.blur &&
            $(".logo-backs").css("filter", "blur(" + t.blur + "px)");
      }
    },
    setLogo: function (e) {
      null != e.company_logo && "" != $.trim(e.company_logo)
        ? ($(".logo-backs2").attr("src", e.company_logo),
          $(".logo-backs2").show())
        : ($(".logo-backs2").attr("src", ""), $(".logo-backs2").hide()),
        $(".logo-backs2").length > 0 &&
          $(".logo-backs2").parent().is("a") &&
          $(".logo-backs2").unwrap(),
        null != e.company_logo &&
      ...
      null != e.arrows &&
        ...
        1 == e.arrows
          ? ($(".next-button").addClass("corner-right"),
            ...
            (document.location.href.indexOf("#page/1") > 0 ||
              document.location.href.indexOf("#page") < 0) &&
              (1 == e.rtl
    ...
    setSlider: function (e) {
      null == e.show_slider ||
      (0 != $.trim(e.show_slider) && !1 !== e.show_slider)
        ? $(".control-bottom .page-bar").show()
        : $(".control-bottom .page-bar").hide();
    },
    setIconset: function (e) {
      ...
      if (
        ($(".next-button").addClass("hz-iconset-2"),
        ...
        (i = parseInt(n[n.length - 1])),
          i < 5 &&
            ($(".next-button").removeClass("hz-iconset-2"),
            $(".previous-button").removeClass("hz-iconset-2"),
            $("#pnlControls").removeClass("hz-iconset-2"),
            $("#pnlZoomStep").removeClass("hz-iconset-2")),
          -1 === e.controls_iconset.indexOf("iconsetu") &&
            (o = e.controls_iconset.replace("_" + i, "_" + t));
      }
      1 == e.arrows &&
        (null != e.controls_iconset
          ? ($(".next-button").css(
              "background-image",
              "url('" + CDN_PATH + "/flipbook/img/" + o + ".png')"
            ),
            $(".previous-button").css(
              "background-image",
              "url('" + CDN_PATH + "/flipbook/img/" + o + ".png')"
          ...
          : ($(".next-button").css(
              "background-image",
              "url('" + CDN_PATH + "/flipbook/img/" + n + ".png')"
            ),
            $(".previous-button").css(
              "background-image",
              "url('" + CDN_PATH + "/flipbook/img/" + n + ".png')"
        ...
        null != e.controls_iconset
          ? ($(".hz-icon").css(
            ...
            $("[data-iconset]").hide(),
            $("[data-iconset=" + e.controls_iconset.split("_")[0] + "]")
              .length > 0
              ? $(
                  "[data-iconset=" + e.controls_iconset.split("_")[0] + "]"
                ).show()
    ...
    setVisibleControls: function (e) {
      let t = !0;
      return (
        null == e.show_zoom || (0 != $.trim(e.show_zoom) && !1 !== e.show_zoom)
          ? ($("#pnlControls .zoom-icon").show(), (t = !1))
          : $("#pnlControls .zoom-icon").hide(),
        null == e.show_share || 0 == $.trim(e.show_share) || !1 === e.show_share
          ? $("#btnShare").hide()
          : ($("#btnShare").show(), (t = !1)),
        null == e.show_search ||
        0 == $.trim(e.show_search) ||
        !1 === e.show_search
          ? $("#btnSearch").hide()
          : ($("#btnSearch").show(), (t = !1)),
        null == e.show_prevnext ||
        (1 != $.trim(e.show_prevnext) && !0 !== e.show_prevnext)
          ? ($("#btnNavPrev").hide(), $("#btnNavNext").hide())
          : ($("#btnNavPrev").show(),
            $("#btnNavNext").show(),
            1 == e.viewer_dir
              ? ($("#btnNavPrev .hz-icon").addClass("button-prev-vertical"),
                $("#btnNavNext .hz-icon").addClass("button-next-vertical"))
              : ($("#btnNavPrev .hz-icon").removeClass("button-prev-vertical"),
                $("#btnNavNext .hz-icon").removeClass("button-next-vertical")),
            (t = !1)),
        null == e.show_start ||
        (1 != $.trim(e.show_start) && !0 !== e.show_start)
          ? $("#btnNavStart").hide()
          : ($("#btnNavStart").show(),
            1 == e.viewer_dir
              ? $("#btnNavStart .hz-icon").addClass("button-start-vertical")
              : $("#btnNavStart .hz-icon").removeClass("button-start-vertical"),
            (t = !1)),
        null == e.show_end || (1 != $.trim(e.show_end) && !0 !== e.show_end)
          ? $("#btnNavEnd").hide()
          : ($("#btnNavEnd").show(),
            1 == e.viewer_dir
              ? $("#btnNavEnd .hz-icon").addClass("button-end-vertical")
              : $("#btnNavEnd .hz-icon").removeClass("button-end-vertical"),
            (t = !1)),
        null == e.sound_flip ||
        (1 != $.trim(e.sound_flip) && !0 !== e.sound_flip)
          ? $("#btnSoundOff").hide()
          : ($("#btnSoundOff").show(), (t = !1)),
        null == e.show_download ||
        (0 != $.trim(e.show_download) && !1 !== e.show_download)
          ? ($(".down-pdf").show(), (t = !1))
          : $(".down-pdf").hide(),
        null == e.show_print ||
        0 == $.trim(e.show_print) ||
        ...
        $.isTouch
          ? $("#btnPrint").hide()
          : ($("#btnPrint").show(), (t = !1)),
        (null != e.show_thumbpanel && 0 != e.show_thumbpanel) ||
        (null != e.show_outline &&
          0 != e.show_outline &&
          2 != e.show_outline) ||
        (null != e.show_bookmarks &&
          0 != e.show_bookmarks &&
          2 != e.show_bookmarks)
          ? ($("#btnNavPanel").show(), (t = !1))
          : $("#btnNavPanel").hide(),
        null == e.show_fullscreen ||
        0 == $.trim(e.show_fullscreen) ||
        !1 === e.show_fullscreen
          ? $("#btnFullscreen").hide()
          : ($("#btnFullscreen").show(), (t = !1)),
        t
      );
    },
    setPageEffect: function (e) {
      ...
      null != e.show_depth &&
        ("0" == e.show_depth
          ? $("#magazineViewport").addClass("no-depth")
          : $("#magazineViewport").removeClass("no-depth")),
        null != e.show_edges && 1 == e.show_edges && (t = "small"),
        null != e.show_shadow &&
          ("0" == e.show_shadow
            ? $("#magazineViewport").addClass("no-shadow")
            : ($("#magazineViewport").removeClass("no-shadow"), (t = "small"))),
        null != e.show_bookmarks &&
          ((2 != e.show_bookmarks && 3 != e.show_bookmarks) || (t = "large")),
        null != e.show_outline &&
          ((2 != e.show_outline && 3 != e.show_outline) || (t = "large")),
        null != e.arrows &&
          3 != e.arrows &&
          (t = "none" == t || "small" == t ? "medium" : t),
        ...
        "large" == t
          ? $("#magazineViewport").addClass("page-controls")
          : "medium" == t
          ? $("#magazineViewport").addClass("page-controls-md")
          : "small" == t &&
            $("#magazineViewport").addClass("page-controls-turn"),
        null != e.show_round &&
          ("1" == e.show_round
        ...
        null != e.show_binding &&
          ("1" == e.show_binding
            ? $("#magazineViewport").addClass("binding-pages")
            : $("#magazineViewport").removeClass("binding-pages")),
        null != e.show_center &&
          ("0" == e.show_center
            ? $("#magazineViewport").addClass("no-center")
            : $("#magazineViewport").removeClass("no-center"));
    },
    setDisposition: function (e, t) {
      $(".controls-pdf").removeClass("controls-sm"),
        ...
        "" == $.trim(e.controls_size) ||
        ("sm" != e.controls_size && "lg" != e.controls_size)
          ? $(".controls-pdf").addClass("controls-md")
          : $(".controls-pdf").addClass("controls-" + e.controls_size),
        "" == $.trim(e.controls_size) ||
        ("sm" != e.controls_size && "lg" != e.controls_size)
          ? $(".controls-pdf").addClass("controls-md")
          : $(".controls-pdf").addClass("controls-" + e.controls_size),
        ...
        "" != $.trim(e.company_logo_style) &&
          0 != e.company_logo_style &&
          $(".logo-backs2").css(JSON.parse(e.company_logo_style)),
        null != e.company_logo && "" != $.trim(e.company_logo)
          ? $(".logo-backs2").show()
          : $(".logo-backs2").hide().css({ width: "0px", height: "0px" });
    },
    setTooltips: function () {
      $.isTouch ||
        ($("#pnlControls #btnNavStart").attr(
          "aria-label",
          heyzine.lang.translate.fromKey("first")
        ),
        $("#pnlControls #btnNavPrev").attr(
          "aria-label",
          heyzine.lang.translate.fromKey("prev")
        ),
        $("#pnlControls #btnNavNext").attr(
          "aria-label",
          heyzine.lang.translate.fromKey("next")
        ),
        $("#pnlControls #btnNavEnd").attr(
          "aria-label",
          heyzine.lang.translate.fromKey("last")
        ),
        $("#pnlControls #btnShare").attr(
          "aria-label",
          heyzine.lang.translate.fromKey("share")
        ),
        $("#pnlControls .down-pdf").attr(
          "aria-label",
          heyzine.lang.translate.fromKey("download")
        ),
        $("#pnlControls #btnPrint").attr(
          "aria-label",
          heyzine.lang.translate.fromKey("print")
        ),
        $("#pnlControls .zoom-icon").attr(
          "aria-label",
          heyzine.lang.translate.fromKey("zoom")
        ),
        $("#pnlControls #btnFullscreen").attr(
          "aria-label",
          heyzine.lang.translate.fromKey("fullscreen")
        ),
        $("#pnlControls #btnSoundOff").attr(
          "aria-label",
          heyzine.lang.translate.fromKey("sound")
        ),
        $("#pnlControls #btnSearch").attr(
          "aria-label",
          heyzine.lang.translate.fromKey("search")
        ),
        $("#pnlControls #btnNavPanel").attr(
          "aria-label",
          heyzine.lang.translate.fromKey("table_contents")
        ),
        $("#pnlZoomStep .btnZoomMore").attr(
          "aria-label",
          heyzine.lang.translate.fromKey("zoomin")
        ),
        $("#pnlZoomStep .btnZoomLess").attr(
          "aria-label",
          heyzine.lang.translate.fromKey("zoomout")
        ),
        $("#pnlNav #btnNavPanelThumbnails").attr(
          "aria-label",
          heyzine.lang.translate.fromKey("thumbnails")
        ),
        $("#pnlNav #btnNavPanelOutline").attr(
          "aria-label",
          heyzine.lang.translate.fromKey("outline")
        ),
        $("#pnlNav #btnNavPanelBookmark").attr(
          "aria-label",
          heyzine.lang.translate.fromKey("bookmark")
        ),
        $("#pnlNav .panel-nav-controls .panel-nav-close").attr(
          "aria-label",
          heyzine.lang.translate.fromKey("close")
        ),
  ...
  (heyzine = {
    ...
    reload: function (e) {
      ...
      return new Promise((t, i) => {
        heyzine.render(),
          null != e
            ? (heyzine.controls.initViewerControls(e), heyzine.layers.init(e))
            : heyzine.controls.initViewerControls(heyzine.config),
          t();
      });
    },
    loadForEditor: function (e) {
    ...
    setViewer: (e, t) => (
      ...
      (heyzine.viewer =
        "SWIPER" == e ? hzflip.viewers.swiper : hzflip.viewers.magazine),
      "magazine" == t || "album" == t
        ? ((heyzine.design.data.show_edges = 1),
        ...
        ? ((heyzine.design.data.show_edges = 1),
          (heyzine.design.data.show_round = 0),
          (heyzine.design.data.show_depth = 1),
          (heyzine.design.data.show_binding = 1))
        : "notebook" == t
        ? ((heyzine.design.data.show_edges = 1),
          ...
          (heyzine.design.data.show_binding = 0))
        : "cards" == t
        ? ((heyzine.design.data.show_edges = 0),
          (heyzine.design.data.show_round = 1),
    ...
    load: (e, t) => {
      ...
      if (
        ...
        document.location.href.indexOf("?dp=1") > 0 ||
        document.location.href.indexOf("&dp=1") > 0
          ? (heyzine.design.data.show_double = 1)
          : (document.location.href.indexOf("?dp=2") > 0 ||
              document.location.href.indexOf("&dp=2") > 0) &&
            (heyzine.design.data.show_double = 2),
        null != heyzine.parseUrl().ap &&
          (heyzine.autoPlay = heyzine.parseUrl().ap),
        null != heyzine.parseUrl().bn &&
          (heyzine.browserNavButtons = heyzine.parseUrl().bn),
        null != heyzine.parseUrl().hn &&
          0 == heyzine.parseUrl().hn &&
          (t.hashNavigation = !1),
        null != heyzine.parseUrl().tag &&
          (heyzine.tag = heyzine.parseUrl().tag),
        null == heyzine.parseUrl().pl ||
          ("tr" != heyzine.parseUrl().pl &&
            "br" != heyzine.parseUrl().pl &&
            "tl" != heyzine.parseUrl().pl &&
            "bl" != heyzine.parseUrl().pl) ||
          (heyzine.peelAnimation = {
            timer: null,
            state: "",
            corner: heyzine.parseUrl().pl,
          }),
        0 == heyzine.inited &&
          (heyzine.helpers.loading.showViewportLoader(), (heyzine.inited = !0)),
        "LOWT" == heyzine.config.mode && scaler.isInIframe())
      )
        return (
          $(".magazine-viewport-loader .loader-preview-cont").append(
            '<div class="lowt-overlay"></div>'
          ),
          $(".magazine-viewport-loader .loader-preview-cont .loader").hide(),
          $(
            ".magazine-viewport-loader .loader-preview-cont img.loader-preview"
          ).css({ filter: "blur(0) opacity(1)", width: "100%" }),
      ...
      if (
        ((null != heyzine.design.data.embed_mode &&
          ...
          (heyzine.toc.src =
            heyzine.tocPath +
            t.thumbnail.replace("-thumb.jpg", "") +
            "-toc.jpg")),
        "" != $.trim(heyzine.design.data.load_page))
      ) {
        const e =
          -1 == heyzine.design.data.load_page
            ? heyzine.storage.getItem("lastpage-" + heyzine.config.name)
            : heyzine.design.data.load_page;
        null != e && (heyzine.loadOnLastPage = e);
      }
      return new Promise((i, n) => {
        null == resetHeyzine && (resetHeyzine = $.extend(!0, {}, heyzine)),
          "IMG" == heyzine.config.mode
            ? $.extend(!0, heyzine, hzimg)
            : "PREV" == heyzine.config.mode
            ? $.extend(!0, heyzine, hzprev)
            : $.extend(!0, heyzine, hzpdf),
          "SWIPER" == heyzine.config.viewer
            ? (heyzine.viewer = hzflip.viewers.swiper)
            : (heyzine.viewer = hzflip.viewers.magazine),
          heyzine
            .load(e, t)
            .then(() => {
              if (
                ...
                null != heyzine.autoPlay &&
                  heyzine.controls.navigation.startAutoPlay(heyzine.autoPlay),
                null != heyzine.loadOnLastPage &&
                  heyzine.goToPage(heyzine.loadOnLastPage),
                null != heyzine.peelAnimation &&
                  null != $(".magazine").turn &&
                  (heyzine.peelAnimation.timer = setInterval(() => {
                    (heyzine.peelAnimation.state =
                      "" == heyzine.peelAnimation.state
                        ? heyzine.peelAnimation.corner
                        : ""),
                ...
                "" != $.trim(e) &&
                  heyzine.controls.search.startSearch(decodeURIComponent(e));
              }
              i("");
            })
            .catch((e) => {
    ...
    firstInteraction: function () {
      ...
      heyzine.layers.userInteraction(e),
        null != heyzine.peelAnimation &&
          null != heyzine.peelAnimation.timer &&
          (clearInterval(heyzine.peelAnimation.timer),
    ...
    render: function () {
      null != heyzine.config &&
        null != heyzine.design &&
        heyzine.viewer.render(heyzine.config, heyzine.design.data),
        heyzine.setCssVariables();
    },
    setCssVariables: function () {
      ...
      (e =
        $(".magazine").length > 0
          ? $(".magazine").outerWidth()
          : $(".magazine-viewport").length > 0
          ? $(".magazine-viewport").outerWidth()
          : $("#canvas").outerWidth()),
        document.documentElement.style.setProperty(
          "--fborder",
          Math.round(0.024 * e) + "px"
        );
    },
    getCurrentPage: function (e) {
      if (null == heyzine || null == heyzine.viewer) {
        const e = Hash.fragment();
        return null != e && "" != $.trim(e.replace("page/", ""))
          ? parseInt(e.replace("page/", ""))
          : null;
      }
    ...
    isSinglePage: function () {
      let e,
        ...
        i = $("#canvas").height();
      return (
        "SWIPER" == this.config.viewer
          ? (e = !0)
          : 0 == this.design.data.show_double
          ? (e = t < 750 && t <= i)
          : 1 == this.design.data.show_double
          ? (e = !1)
          : 2 == this.design.data.show_double && (e = !0),
        e
      );
    },
    ...
    turned: function (e, t) {
      if (
        ...
        -1 === heyzine.design.data.load_page &&
          heyzine.storage.setItem("lastpage-" + heyzine.config.name, e),
        $(document).trigger("heyzineTurned", [heyzine.config.name, e]),
        "undefined" != typeof heyzinea &&
          null != heyzinea.api &&
          null != heyzinea.api.flipbook &&
          null != heyzinea.api.flipbook.onPageChange)
      ) {
        const e = heyzine.getVisiblePages();
        for (let t = 0; t < e.length; t++)
    ...
    setPageCache: function (e, t, i, n) {
      const o =
        "hz_cache_" + Math.trunc(i) + "_p_" + e + "_" + t + "_" + heyzine.url;
      this.isSessionStorageEnabled()
        ? sessionStorage.setItem(o, n)
        : (window.hstorage[o] = n);
    },
    getPageCache: function (e, t, i) {
      const n =
        "hz_cache_" + Math.trunc(i) + "_p_" + e + "_" + t + "_" + heyzine.url;
      return this.isSessionStorageEnabled()
      ...
      if ("start" == e || this.progressState.started) {
        if ("start" == e)
          ...
          this.progressState.progress +=
            t.inc / this.progressState.numIndicators;
        else {
          if ("end" == e)
            return (
          ...
          "cancel" == e &&
            ((this.progressState.started = !1), $("#loaderLine").hide());
        }
        $("#loaderLine").css(
          "width",
          (this.progressState.progress * $(window).width()) / 100 + "px"
        );
      }
    },
    parseUrl: function (e) {
    ...
    getBound: function () {
      ...
      let o = { boundWidth: e, boundHeight: t },
        s = i / n.height;
      return (
        s <= o.boundWidth / o.boundHeight
          ? ((n.width = Math.round(o.boundHeight * s)),
            (n.height = o.boundHeight),
            (n.fit = "height"))
          : ((n.width = o.boundWidth),
    ...
    coverPagesClass: (e, t) => {
      ...
      t - heyzine.design.data.cover == 1
        ? n.addClass("page-first")
        : t - heyzine.design.data.cover == i.num_pages &&
          n.addClass("page-last");
    },
  }),
  ...
  (heyzine.lang.text.ca = {
    ...
    skip: "Salta",
    privacy:
      'Accepto la <a href="{link}" target="_BLANK">política de privacitat</a> de {company}.',
  ...
  (heyzine.lang.text.de = {
    ...
    skip: "Überspringen",
    privacy:
      'Ich akzeptiere die <a href="{link}" target="_BLANK">Datenschutzbestimmungen</a> von {company}.',
  ...
  (heyzine.lang.text.en = {
    ...
    skip: "Skip",
    privacy:
      'I accept {company}\'s <a href="{link}" target="_BLANK">privacy policy</a>.',
  ...
  (heyzine.lang.text.es = {
    ...
    skip: "Saltar",
    privacy:
      'Acepto la <a href="{link}" target="_BLANK">política de privacidad</a> de {company}.',
  ...
  (heyzine.lang.text.fr = {
    ...
    skip: "Skip",
    privacy:
      'J\'accepte la <a href="{link}" target="_BLANK">politique de confidentialité</a> de {company}.',
  ...
  (heyzine.lang.text.pt = {
    ...
    skip: "Pular",
    privacy:
      'Aceito a <a href="{link}" target="_BLANK">política de privacidade</a> de {company}.',
  ...
  (heyzine.lang.translate = {
    ...
    fromKey: function (e) {
      let t = "en";
      return (
        null != heyzine.lang.text[this.lang] && (t = this.lang),
    ...
    getLangCode: function () {
      ...
      if (Array.isArray(i.languages))
        for (e = 0; e < i.languages.length; e++)
          if ((t = i.languages[e]) && t.length) return t;
